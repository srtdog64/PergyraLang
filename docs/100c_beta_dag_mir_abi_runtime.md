...
## MIR And Direct-LLVM Substitution Notes

Moved out of `docs/100a_beta_active_status.md` on 2026-08-05, following this
family's own rule: keep an entry in the shard that owns its closure track.
These are MIR and direct-LLVM substitution notes, so they belong here rather
than in the active-status shard, which had outgrown its size cap.
