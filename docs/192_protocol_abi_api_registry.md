...
pergyra.selfhost-driver-cli.unversioned | UNREGISTERED:typed-argv-request-owner | src/self_hosted/compiler/driver_bootstrap_main.pgy#--emit-c-artifact-verified;src/self_hosted/compiler/driver_rung2_cli_owner.pgy#--emit-c-verified | src/compiler/self_host_driver.c#driver_materialize_self_host_c_artifact;src/self_hosted/compiler/driver_bootstrap_main.pgy#Main | src/self_hosted/compiler/driver_bootstrap_main.pgy;src/self_hosted/compiler/driver_rung2_main.pgy | src/self_hosted/compiler/driver_rung2_cli_owner.pgy#RunDriverRung2FromArgs | src/self_hosted/compiler/driver_bootstrap_main.pgy#source C artifact mode requires source and output paths;src/self_hosted/compiler/driver_rung2_cli_owner.pgy#unknown driver rung-2 mode | tests/self_hosted/parity/installed_driver_cli_mode_owner.sh#positional fallback rejected | Makefile#self-host-installed-driver-cli-mode-test-smoke | BRIDGE
