...
surface is not migrated behind one owner. Runtime-call ABI rows have a version
and parity artifact, but no dedicated top-level SoT owner or compatibility
policy. LSP has staged self-host transport/diagnostic owners, but no single
