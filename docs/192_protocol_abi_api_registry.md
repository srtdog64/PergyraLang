...
pergyra.selfhost-driver-cli.v1 | registry:selfhost.driver_cli_request | src/self_hosted/compiler/driver_rung2_cli_request_owner.pgy#DriverRung2CliRequest | src/pgy_driver.c#driver_self_host_mir_json_request_supported;src/compiler/self_host_driver.c#driver_run_self_host_mir_json;src/compiler/self_host_driver.c#driver_materialize_self_host_c_artifact;src/compiler/self_host_llvm_driver.c#driver_materialize_self_host_llvm_artifacts;src/self_hosted/compiler/driver_rung2_cli_request_owner.pgy#DriverRung2CliRequestFromArgsOrDie | src/pgy_driver.c;src/self_hosted/compiler/driver_rung2_cli_read_execution_owner.pgy;src/self_hosted/compiler/driver_rung2_installed_cli_owner.pgy | src/pgy_driver.c#return driver_run_self_host_mir_json(;src/self_hosted/compiler/driver_rung2_cli_read_execution_owner.pgy#DriverRung2ExecuteReadRequest;src/self_hosted/compiler/driver_rung2_installed_cli_owner.pgy#DriverRung2ExecuteInstalledRequest | src/pgy_driver.c#--mir-json options are outside the installed self-host driver contract;src/self_hosted/compiler/driver_rung2_cli_request_owner.pgy#driver rung-2 requires an explicit source or mode;src/self_hosted/compiler/driver_rung2_cli_request_owner.pgy#source MIR mode requires stdout, explicit machine manifest, or -o artifact syntax | docs/semantics/sot_owner_spine_registry.md#selfhost.driver_cli_request | tests/self_hosted/parity/public_mir_json_installed_self_host_owner.sh#[self-host-public-mir-json] installed Pergyra producer owns public source-to-MIR;tests/self_hosted/parity/installed_driver_cli_mode_owner.sh#one typed argv owner keeps source-C, source-MIR, and MIR-C stdout/artifact effects disjoint;tests/self_hosted/parity/driver_source_mir_execution_action_gate.sh#pure CLI request admission regained compiler or I/O authority;Makefile#self-host-public-mir-json-replacement-test-smoke;Makefile#self-host-installed-driver-cli-mode-test-smoke | IMPLEMENTED
