...
- Strict beta readiness is now about 75% after source-of-truth gates for
  ...
  not yet 80%; that line requires consumer-completeness across CFG/AIR
...
- 베타 readiness 추정: 기능 체감 `약 70%`, strict beta readiness `약 75%`
- 판정 방식:
  ...
  - 따라서 현재 공식 수치는 기능 개수 기준이 아니라 **strict beta readiness 약 75%**로 둔다. 80%는 CFG/AIR consumer-completeness, MIR/LLVM declaration bootstrap, ABI/Slot/Pin freeze가 닫힌 뒤 재평가한다
- 핵심 판단:
