...
| [`194_mn_scheduler_join_blueprint.md`](194_mn_scheduler_join_blueprint.md) | WO-MN-1 blueprint: measured inventory and rung ladder for joining the M:N fiber scheduler as the MovableScheduler lane executor |
| [`197_region_arena_strategy.md`](197_region_arena_strategy.md) | WO-REG strategy: census of the twice-declared never-consumed arena, verified region plan architecture, escape-certificate rules, and the rung ladder to a declared `region` surface |
...
| [`131_ai_coding_atomic_units.md`](131_ai_coding_atomic_units.md) | AI-coding discipline: objective functions, verifiable intent atoms, epistemic impedance mismatch, risk-scaled gate trust, and verification graphs |
