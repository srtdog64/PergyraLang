...
tracked separately as `routine_source_decl_codegen`, locked at 1.
...
storage but no declaration inventory row. Routine source declaration checks go through the
