...
same manifest. `mir_lower` now reconstructs the supported 60-fixture parity
...
statement blocks. The committed MIR-lower/codegen fixture inventory is now
measured at 60 PASS / 0 gap through this path;
