...
- `text/struct_literal_field_owner.pgy` owns struct literal field-name/value
  entry facts, including positional field fallback from collected field rows.
