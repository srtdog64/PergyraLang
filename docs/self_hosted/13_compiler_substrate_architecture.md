...
and bare-call payloads. Compound statement payloads remain bridge-owned until
they are represented as row-shaped arena facts.
...
owner facts until their multi-field payloads move into typed rows. Parameter
mode is part of this bridge contract: native and
