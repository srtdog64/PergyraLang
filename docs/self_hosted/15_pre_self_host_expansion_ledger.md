...
TypedAst delta, 2026-07-07: `AstArena` now carries type-name and mode rows in
addition to kind, atom, parent, indent, and child-edge rows. Function and
