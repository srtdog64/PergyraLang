...
| JSON read/emit primitives | `src/self_hosted/lib/json.pgy` | component contract and real-source selfcheck | shared string/number/span reads plus JSON string, field, object, and array emission for fact-shaped tools |
