...
| Remaining runtime helper spelling | named runtime ABI owners for math and file/argv helper names | Collection, Option/Result, and string/text call names are owned; the remaining direct helper spellings still let call-site drift reappear. |
