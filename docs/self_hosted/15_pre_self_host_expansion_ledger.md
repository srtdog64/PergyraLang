...
from `codegen_run_owner.pgy`, projects those base names into source paths, and
ratchets the driver fixture frontier to the 68 committed codegen parity
fixtures. DRV-0 and DRV-1 shell runners reject manifest count drift.
