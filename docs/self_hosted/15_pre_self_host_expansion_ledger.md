...
not cross the artifact boundary. The mixed-tree blocker remains ACTIVE because
the semantic substitute still scans source text instead of consuming this
artifact and because expression facts remain compact-text backed.
