...
tracked by `CompilerLspSessionReplayArtifactKind()`. Content-Length transport,
request-dispatch, response-emission, and session-replay parity must not reuse
or alias the LSP diagnostics artifact.
