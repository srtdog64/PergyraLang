...
Artifact Zone delta, 2026-07-04: LSP-2a single-frame transport output is now
tracked as its own comparable artifact kind,
`CompilerLspTransportFrameArtifactKind()`, so Content-Length frame parity does
not reuse or alias the LSP diagnostics artifact.
