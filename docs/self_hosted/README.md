...
driver) after being shown the initial inventory. The canonical tracker now
separates live implementation inventory, verified component frontier, and
released/native replacement because **implementation volume is not substitution**.
Runtime/compiler driver/LSP replacement remains at 0%. Hard migration proceeds
