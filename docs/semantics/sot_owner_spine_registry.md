...
diagnostic.catalog | diagnostic | DiagnosticId | SFDiagnosticCatalog | SODiagnosticCatalog | src/semantic/diag_codes.h | PGY_CODE_SEM_TYPE_MISMATCH | src/semantic/type_checker_diag.c,src/compiler/driver_diag.c,src/self_hosted/semantic/diagnostic_code_owner.pgy,src/self_hosted/semantic/public_diagnostic_receipt_owner.pgy,src/self_hosted/compiler/driver_rung2_owner.pgy,src/self_hosted/compiler/driver_source_mir_json_diagnostic_stdout_owner.pgy,src/compiler/self_host_mir_diagnostic_stdout_owner.c,src/compiler/self_host_public_diagnostic_wire_owner.c | free_text_code_recovery,stage_guess_from_message,public_json_identity_from_message,native_retry_after_invalid_receipt,c_semantic_diagnostic_mapping | tests/diagnostic_registry_smoke.sh#macros and call sites ok,tests/self_hosted/parity/public_mir_json_diagnostic_receipt_owner.sh#typed Pergyra identity, opaque C relay, wording independence, and fail-closed wire | BRIDGE | default installed MIR JSON now carries exact semantic code/stage/cause/fix from the Pergyra receipt without message scanning; native module-load, AIR, runtime, and other free-text diagnostic mappings remain open
