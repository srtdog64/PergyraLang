...
semantic.builtin_capability_policy | semantic | BuiltinCapabilityPolicyId | SFBuiltinCapabilityPolicy | SOBuiltinCapabilityPolicy | src/semantic/builtin_capability_registry.def | PGY_BUILTIN_CAPABILITY_POLICY_ROWS | src/semantic/capability_analyze.c,src/semantic/type_checker_program.c,src/semantic/type_checker_builtins_stdlib_body.c,src/runtime/pgy_runtime_io_qubit_inline.h,src/runtime/pgy_runtime_lib_io_string_exports.h,src/self_hosted/semantic/builtin_capability_projection_owner.pgy,src/self_hosted/semantic/ast_capability_call_graph_owner.pgy,src/self_hosted/lsp/live_session_owner.pgy | native_builtin_capability_switch,selfhost_builtin_capability_switch,manifest_builtin_name_rescan,missing_builtin_capability_registry_success,print_semantic_capability_bypass,print_runtime_capability_bypass,print_bytes_before_capability_admission | tests/builtin_capability_registry_smoke.sh#builtin capability registry smoke: ok,tests/capability/run_runtime_enforce.sh#print denied clean,tests/self_hosted/parity/lsp_live_session_owner.sh#io_write denial emitted a partial protocol response | CLOSED | none
semantic.file_mode_capability_policy | semantic | FileModeCapabilityPolicyId | SFFileModeCapabilityPolicy | SOFileModeCapabilityPolicy | src/runtime/pgy_file_mode_capability.def | PGY_FILE_MODE_CAPABILITY_POLICY_ROWS | src/runtime/pgy_runtime_file_mode_capability.h,scripts/render_builtin_capability_registry.py,src/self_hosted/semantic/builtin_capability_projection_owner.pgy,src/self_hosted/semantic/ast_capability_call_graph_owner.pgy | native_file_mode_character_switch,selfhost_file_mode_character_switch,dynamic_file_mode_read_only_default,unknown_file_mode_empty_capability | tests/builtin_capability_registry_smoke.sh#builtin capability registry smoke: ok | CLOSED | none
selfhost.source_capability_facts | semantic | SelfHostSourceCapabilityFactId | SFSelfHostSourceCapabilityFacts | SOSelfHostSemanticCapability | src/self_hosted/semantic/ast_capability_fact_owner.pgy | SemanticAstCapabilityFactsFromAdmittedBody | src/self_hosted/semantic/ast_body_type_bundle_owner.pgy,src/self_hosted/semantic/ast_body_type_bundle_readiness_owner.pgy,src/self_hosted/compiler/capability_manifest_owner.pgy,src/self_hosted/compiler/driver_rung2_cli_read_execution_owner.pgy | capability_declared_as_used,capability_renderer_builtin_rescan,capability_missing_call_target_success,capability_program_mask_without_callable_fixed_point,immutable_source_capability_manifest_companion,public_capability_manifest_native_fallback,missing_capability_driver_native_retry | tests/self_hosted/parity/public_capability_manifest_installed_self_host_owner.sh#installed semantic facts own public output and fail closed,tests/builtin_capability_registry_smoke.sh#builtin capability registry smoke: ok,tests/self_hosted/parity/intent_capability_fact_owner.sh#10 native-C identity/missing-row controls PASS,tests/self_hosted/parity/callable_capability_fact_owner.sh#10 native-C substitution/identity/deferred-use controls PASS | CLOSED | none
semantic.callable_receiver_carriage | abi | CallableSyntaxId | SFCallableReceiverCarriage | SOSemanticCallableReceiver | src/self_hosted/semantic/callable_receiver_carriage_policy_owner.pgy | CallableReceiverCarriageKnown | src/compiler/mir.c,src/compiler/mir_program_fact_validate.c,src/compiler/mir_json_dump.c,src/self_hosted/mir/routine_receiver_carriage_owner.pgy,src/self_hosted/mir/json_projection_owner.pgy,src/self_hosted/mir/program_json_artifact_writer_owner.pgy,src/self_hosted/mir_lower/program_routine_receiver_identity_owner.pgy,src/self_hosted/mir_lower/program_routine_index_owner.pgy,src/self_hosted/semantic/role_operator_resolution_owner.pgy,src/self_hosted/semantic/ast_body_role_operator_resolution_owner.pgy,src/self_hosted/codegen/input/callable_receiver_codegen_view_owner.pgy,src/self_hosted/compiler/codegen_callable_receiver_bridge_owner.pgy,src/self_hosted/codegen/emission/function_global_env_owner.pgy,src/self_hosted/codegen/emission/function_prototype_block_owner.pgy,src/self_hosted/codegen/emission/function_emit.pgy,src/self_hosted/codegen/emission/expr_semantic_call_emit_owner.pgy,src/self_hosted/codegen/emission/implicit_receiver_c_parameter_owner.pgy,src/self_hosted/codegen/emission/member_call_receiver_carriage_owner.pgy,src/self_hosted/codegen/emission/role_receiver_binding_owner.pgy,src/self_hosted/compiler/direct_mir_mutable_nominal_identity_plan_owner.pgy,src/self_hosted/compiler/direct_mir_role_operator_declaration_fact_owner.pgy,src/self_hosted/compiler/direct_mir_role_operator_plan_owner.pgy,src/self_hosted/compiler/direct_mir_role_operator_abi_projection_owner.pgy,src/self_hosted/compiler/direct_mir_role_operator_emission_owner.pgy,src/self_hosted/compiler/direct_mir_role_override_program_identity_owner.pgy,src/self_hosted/compiler/direct_mir_role_override_plan_owner.pgy,src/self_hosted/compiler/direct_mir_role_override_target_projection_owner.pgy,src/self_hosted/compiler/direct_mir_role_override_emission_owner.pgy | missing_receiver_carriage_success,unknown_receiver_carriage_success,owner_name_only_join,duplicate_nominal_receiver_policy,mutable_identity_by_value,temporary_mutable_receiver_address,role_erased_mutable_receiver_copy,missing_concrete_role_target_carriage_success,late_role_target_rescan,general_parameter_abi_from_receiver_carriage,role_operator_target_from_spelling,sole_visible_role_dispatch,primitive_operator_retry_after_role_claim,implicit_receiver_from_visible_parameter_list,role_override_receiver_from_source_text,role_override_target_abi_hardcode,role_override_concrete_role_receiver | tests/self_hosted/parity/mir_receiver_carriage_admission_owner.sh#[self-host-parity:mir-receiver-carriage-admission] PASS,tests/self_hosted/parity/driver_rung2_callable_receiver_carriage_owner.sh#accepted a temporary mutable receiver,tests/self_hosted/parity/driver_rung2_callable_receiver_carriage_owner.sh#mutable role target was copied,tests/self_hosted/parity/one_mir_mutable_nominal_identity_projection.sh#subject exact 7 + vessel exact 13, one mutable owner,tests/self_hosted/parity/one_mir_role_operator_projection.sh#exact C/LLVM 123, 6 metamorphic cases,tests/self_hosted/parity/codegen_role_receiver_admission_owner.sh#PASS exact base/metamorphic execution and negative admission,tests/self_hosted/parity/role_override_mir_replacement.sh#8 role C/LLVM runtime legs + 3 receiver runtimes + 14 source negatives | BRIDGE | native and self MIR carry mandatory none/value/mutable-identity rows through exact callable/declaration identity and the general self C consumer emits pointer self plus stable-address calls; role-erased local ABI preserves mutable concrete targets behind the erased pointer. The bounded role-operator path now resolves one semantic target, carries it through MIR, and executes exact 123 through one target-neutral plan plus selected C/LLVM ABI projection without source, display, sole-role, or primitive-arithmetic fallback. Bounded subject/vessel literals exact-7/13 also consume this carriage without aggregate copy. The general self codegen receiver now binds exact role target type plus distinct value-or-identity carriage once at callable admission, executes builtin Int by value, preserves mutable nominal pointer identity, and rejects late nominal-kind reconstruction or non-copyable builtin targets. The bounded role-override path preserves an exact 0/1 source receiver offset across definition, prototype, environment, and call consumers, and carries sealed ABI evidence through one target projection so C uses a concrete subject pointer plus an erased void role pointer while emitting the role body separately. The row remains BRIDGE because MIR does not yet carry this concrete target carriage as its own callable row and native C/LLVM plus general parameter ABI still reuse the broader uses_pointer_self compatibility policy
...
semantic.function_param_flow_summary | resource | FunctionIdParamIndex | SFFunctionParamFlowSummary | SOFunctionParamFlowSummary | src/semantic/function_param_flow_summary.c | function_param_flow_summary_demand | src/semantic/slot_analyzer.c,src/semantic/slot_analyzer_access.c,src/semantic/slot_analyzer_escape.c,src/semantic/type_checker_call_contract_helpers.c,src/compiler/hir.c,src/compiler/mir.c,src/compiler/mir_program_fact_validate.c,src/compiler/air_evidence_mir.c,src/self_hosted/mir_lower/routine_fact_index_owner.pgy | recursive_callee_body_reopen,depth_limited_summary_truncation,unknown_HIR_routine_attachment,unknown_MIR_routine_attachment,unknown_AIR_routine_attachment,unknown_selfhost_summary_consumer | tests/function_param_flow_summary_smoke.sh#demanded recursive fixed point and no-reopen gates passed,tests/hir_function_param_flow_summary_smoke.sh#semantic summary rows reach HIR with stable identity and validation,tests/air_function_param_flow_summary_smoke.sh#MIR summary rows reach AIR with stable identity and fail-closed validation,tests/self_hosted/mir_function_param_flow_summary_smoke.sh#live MIR JSON summary rows reach routine identity and malformed rows fail closed | CLOSED | none
...
diagnostic.catalog | diagnostic | DiagnosticId | SFDiagnosticCatalog | SODiagnosticCatalog | src/semantic/diag_codes.h | PGY_CODE_SEM_TYPE_MISMATCH | src/semantic/type_checker_diag.c,src/compiler/driver_diag.c,src/self_hosted/semantic/diagnostic_code_owner.pgy,src/self_hosted/lib/public_diagnostic_receipt_owner.pgy,src/self_hosted/semantic/public_diagnostic_receipt_owner.pgy,src/self_hosted/parser/diagnostic_owner.pgy,src/self_hosted/lexer/public_diagnostic_receipt_owner.pgy,src/self_hosted/lexer/scan_owner.pgy,src/self_hosted/compiler/driver_rung2_owner.pgy,src/self_hosted/compiler/driver_rung2_cli_request_owner.pgy,src/self_hosted/compiler/driver_rung2_cli_read_execution_owner.pgy,src/self_hosted/compiler/driver_rung2_artifact_request_execution_owner.pgy,src/self_hosted/compiler/driver_source_mir_json_diagnostic_stdout_owner.pgy,src/compiler/self_host_mir_diagnostic_stdout_owner.c,src/compiler/self_host_public_diagnostic_wire_owner.c,src/compiler/self_host_public_diagnostic_stdout_process_owner.c,src/compiler/self_host_artifact_process_owner.c,src/compiler/self_host_llvm_driver.c,src/compiler/self_host_llvm_ir_stdout_owner.c,src/compiler/self_host_llvm_ir_artifact_owner.c | free_text_code_recovery,stage_guess_from_message,public_json_identity_from_message,native_retry_after_invalid_receipt,c_semantic_diagnostic_mapping,c_parser_diagnostic_mapping | tests/diagnostic_registry_smoke.sh#macros and call sites ok,tests/self_hosted/parity/public_mir_json_diagnostic_receipt_owner.sh#typed Pergyra identity, opaque C relay, wording independence, and fail-closed wire,tests/self_hosted/parity/public_return_type_mismatch_json_diagnostic_receipt_owner.sh#exact semantic identity, MIR/C/LLVM relay, and unrelated-code exclusion,tests/self_hosted/parity/public_logical_operand_json_diagnostic_receipt_owner.sh#exact binary-operand identity, five semantic contexts, MIR/C/LLVM relay, and undefined-symbol exclusion,tests/self_hosted/parity/public_condition_not_bool_json_diagnostic_receipt_owner.sh#exact condition identity, if/while contexts, MIR/C/LLVM relay, and return/logical/unary distinction,tests/self_hosted/parity/public_not_operand_json_diagnostic_receipt_owner.sh#exact unary identity, MIR/C/LLVM relay, admitted-family distinction, and undefined-symbol exclusion,tests/self_hosted/parity/public_compare_type_mismatch_json_diagnostic_receipt_owner.sh#exact shared binary identity, three semantic contexts, MIR/C/LLVM relay, and undefined-symbol exclusion,tests/self_hosted/parity/public_binop_type_mismatch_json_diagnostic_receipt_owner.sh#exact binary-operand identity, four semantic contexts, MIR/C/LLVM relay, and symbol/missing-oracle/unknown-code exclusion,tests/self_hosted/parity/public_let_type_mismatch_json_diagnostic_receipt_owner.sh#exact assignability identity, thirteen semantic contexts, MIR/C/LLVM relay, and undefined-symbol exclusion,tests/self_hosted/parity/public_assign_type_mismatch_json_diagnostic_receipt_owner.sh#exact assignability identity, MIR/C/LLVM relay, and undefined-symbol exclusion,tests/self_hosted/parity/public_call_arg_type_mismatch_json_diagnostic_receipt_owner.sh#exact assignability identity, thirteen refusals, two numeric controls, MIR/C/LLVM relay, and undefined-symbol exclusion,tests/self_hosted/parity/vessel_method_argument_type_admission_owner.sh#graph-owned vessel method argument rejection, exact MIR/C/LLVM receipt, native identity, general-call distinction, and valid control,tests/self_hosted/parity/public_builtin_arg_type_mismatch_json_diagnostic_receipt_owner.sh#exact builtin-signature identity, IsSome/UnwrapOption contexts, MIR/C/LLVM relay, and missing-oracle/unknown-code exclusion,tests/self_hosted/parity/public_value_param_collection_mutation_json_diagnostic_receipt_owner.sh#one mutation policy rejects ArrayPush/ArraySet, relays exact MIR/C/LLVM identity, and excludes symbol/missing-oracle codes,tests/self_hosted/parity/public_call_arity_mismatch_json_diagnostic_receipt_owner.sh#exact builtin-signature identity, builtin/user arity contexts, MIR/C/LLVM relay, and symbol/missing-oracle/unknown-code exclusion,tests/self_hosted/parity/public_parser_callable_contract_json_diagnostic_receipt_owner.sh#parser-owned MIR/C/LLVM receipt, text preservation, and opaque C relay,tests/self_hosted/parity/public_llvm_ir_json_diagnostic_receipt_owner.sh#stdout/file bytes, exact Pergyra receipt, and opaque C relay,tests/self_hosted/parity/public_ast_json_diagnostic_receipt_owner.sh#AST bytes, exact callable-contract, statement-terminator, and statement-head unexpected-token parser receipts, and single opaque process owner,tests/self_hosted/parity/public_tokens_json_diagnostic_receipt_owner.sh#token bytes, exact lexer receipt, formatter stability, and shared opaque process owner | BRIDGE | default installed MIR JSON carries exact semantic code/stage/cause/fix from the Pergyra receipt without message scanning; the Pergyra-owned return_type_mismatch carries exact assignability identity through public MIR/C/LLVM while other verdicts sharing its public code remain fail-closed; the Pergyra-owned logical_operand_not_bool code carries one exact binary-operand identity from all five semantic fixture contexts through public MIR/C/LLVM; the Pergyra-owned condition_not_bool code carries one exact condition identity from both if/while contexts through public MIR/C/LLVM; the Pergyra-owned not_operand_not_bool code carries one exact unary-operand identity through public MIR/C/LLVM while return, logical, and condition receipts remain distinct; the Pergyra-owned compare_type_mismatch code carries the shared binary-operand identity from assign/condition/operand contexts through public MIR/C/LLVM with undefined-symbol exclusion; the separately admitted Pergyra-owned binop_type_mismatch code carries that exact identity from let/assignment/condition/return contexts through public MIR/C/LLVM while undefined-symbol, missing-oracle option, and unknown public codes remain fail-closed; the Pergyra-owned let_type_mismatch code carries the exact assignability identity from thirteen semantic contexts through public MIR/C/LLVM with undefined-symbol exclusion; the Pergyra-owned assign_type_mismatch code carries the exact assignability identity through public MIR/C/LLVM with undefined-symbol exclusion; the Pergyra-owned call_arg_type_mismatch code carries the exact assignability identity from thirteen semantic contexts through public MIR/C/LLVM with undefined-symbol exclusion; the separately registered Pergyra-owned member_call_arg_type_mismatch consumes the resolved member target/signature facts before MIR and carries native call-specific identity through public MIR/C/LLVM while the general-call identity remains unchanged; the Pergyra-owned builtin_arg_type_mismatch code carries the exact builtin-signature identity from IsSome and UnwrapOption contexts through public MIR/C/LLVM while missing-oracle option_concrete_type_required and unknown public codes remain fail-closed; the Pergyra-owned value_param_collection_mutation code reuses one mutation policy for ArrayPush and direct ArraySet rejection and carries the exact builtin-signature identity through public MIR/C/LLVM while undefined-symbol, missing-oracle option, and unknown public codes remain fail-closed; the Pergyra-owned call_arity_mismatch code carries the exact builtin-signature identity from builtin and user-call arity contexts through public MIR/C/LLVM while undefined-symbol, missing-oracle option, and unknown public codes remain fail-closed; duplicate/unknown/exclusive callable-contract rejections carry exact parser-owned public identity through installed MIR/C/LLVM JSON paths using one shared Pergyra wire renderer; public LLVM IR stdout/file JSON requests carry the admitted format Bool into the same source-LLVM intent and opaque C receipt relay; public AST JSON carries the admitted Bool into the same parser artifact projection, publishes exact callable-contract, statement-terminator, and statement-head unexpected-token parser receipts, and shares one opaque diagnostic stdout process owner with MIR; public token JSON carries the admitted Bool into the existing token request while the Pergyra lexer owns the invalid-token identity and the same opaque process owner relays its receipt; native module-load, broader parse/lex, AIR, runtime, and other free-text diagnostic mappings remain open
...
compatibility.evolution | compatibility | CompatibilitySurfaceId | SFCompatibilityEvolution | SOCompatibilityEvolution | src/self_hosted/compiler/compatibility_evolution_owner.pgy | CompilerCompatibilityExecutionViewFromReceipt | src/self_hosted/compiler/compatibility_evolution_manifest.pgy,src/self_hosted/tools/compatibility_evolution_checker/report_owner.pgy,src/self_hosted/compiler/driver_bootstrap_main.pgy,src/self_hosted/compiler/driver_rung2_installed_cli_owner.pgy,src/self_hosted/compiler/driver_rung2_cli_read_execution_owner.pgy,src/self_hosted/compiler/driver_rung2_artifact_request_execution_owner.pgy | local_compatibility_list,warning_without_migration_metadata,native_compatibility_text_manifest_read,serialized_compatibility_row_reparse,root_only_compatibility_readiness | tests/self_hosted/parity/compatibility_evolution_manifest_parity.sh#local_compatibility_list,tests/self_hosted/parity/compatibility_evolution_manifest_parity.sh#warning_without_migration_metadata,tests/self_hosted/parity/compatibility_evolution_manifest_parity.sh#native_compatibility_text_manifest_read,tests/self_hosted/parity/compatibility_evolution_manifest_parity.sh#serialized_compatibility_row_reparse,tests/self_hosted/parity/compatibility_evolution_manifest_parity.sh#root_only_compatibility_readiness,tests/self_hosted/parity/compatibility_evolution_manifest_parity.sh#parity ok,tests/compatibility_evolution_native_smoke.sh#explicit native oracle no longer reparses the self-host text projection,tests/self_hosted/parity/package_commands_installed_self_host_owner.sh#package commands consume installed MIR/C/LLVM artifacts and fail closed,tests/self_hosted/parity/installed_driver_cli_mode_owner.sh#one typed argv owner keeps public MIR diagnostic, source-C, source-MIR, and MIR-C effects disjoint | CLOSED | none
...
selfhost.role_declaration_rows | semantic | SyntaxNodeId | SFRoleDeclarationRows | SOSemanticRole | src/self_hosted/semantic/ast_role_fact_owner.pgy | SemanticAstRoleFacts | src/self_hosted/codegen/input/semantic_role_codegen_view_owner.pgy,src/self_hosted/semantic/ast_body_role_operator_resolution_owner.pgy,src/self_hosted/mir/declaration_callable_rows_owner.pgy,src/self_hosted/mir/declaration_rows_owner.pgy,src/self_hosted/codegen/emission/function_emit.pgy,src/self_hosted/codegen/emission/role_dispatch_emit_owner.pgy,src/self_hosted/codegen/emission/program_emit.pgy | ast_text_role_declaration_owner.pgy,CodegenAstArenaRoleNameOrDie,CodegenAstArenaRoleTargetTypeNameOrDie,CodegenAstArenaIsRoleDecl,"CodegenAstArenaIsDescendantOf(arena, j, i)",direct_override_as_ability_impl,direct_override_method_drop | tests/sot_authority_adequacy_smoke.sh#live owner/consumer binding and negative mutations ok,tests/self_hosted/parity/role_override_mir_replacement.sh#AST/MIR parity | CLOSED | none
selfhost.ability_generic_bounds | semantic | SyntaxNodeIdGenericParameterIndex | SFAbilityGenericBounds | SOSemanticRole | src/self_hosted/semantic/ast_role_fact_owner.pgy | SemanticAstRoleFactsFromArtifact | src/self_hosted/semantic/ast_ability_generic_bound_verdict_owner.pgy,src/self_hosted/semantic/ast_artifact_verdict_owner.pgy,src/self_hosted/mir/declaration_rows_owner.pgy,src/self_hosted/mir_lower/decl_lower.pgy,src/compiler/mir_decl_header_generic_metadata.c,src/self_hosted/codegen/emission/role_dispatch_emit_owner.pgy,src/self_hosted/codegen/emission/program_emit.pgy,src/self_hosted/compiler/driver_rung2_owner.pgy | TypedAstArenaAtomText,TypedAstArenaChildAt,AstNodeMetaValueOr | tests/self_hosted/parity/driver_rung2_generic_multi_bound_defaults_parity_owner.sh#Owns ordered ability-bound/default carriage and its fail-closed falsifier. | CLOSED | none
...
selfhost.expression_surface | semantic | SyntaxNodeId | SFExpressionSurface | SOSemanticExpressionSurface | src/self_hosted/semantic/ast_expression_surface_fact_owner.pgy | SemanticAstExpressionSurfaceFacts | src/self_hosted/semantic/ast_expression_graph_struct_type_verdict_owner.pgy,src/self_hosted/semantic/ast_expression_graph_field_type_owner.pgy,src/self_hosted/semantic/ast_expression_verdict_owner.pgy,src/self_hosted/semantic/ast_expression_verdict_fact_owner.pgy,src/self_hosted/semantic/ast_initializer_type_fact_owner.pgy,src/self_hosted/semantic/ast_statement_type_fact_owner.pgy,src/self_hosted/semantic/ast_assignment_type_fact_owner.pgy,src/self_hosted/semantic/ast_iteration_type_fact_owner.pgy,src/self_hosted/semantic/ast_expression_graph_generic_call_owner.pgy,src/self_hosted/semantic/ast_generic_specialization_fact_owner.pgy,src/self_hosted/semantic/ast_expression_graph_call_view_owner.pgy,src/self_hosted/codegen/input/ast_expression_usage_owner.pgy,src/self_hosted/codegen/input/ast_usage_owner.pgy,src/self_hosted/codegen/input/semantic_expression_codegen_view_owner.pgy,src/self_hosted/codegen/emission/expr_semantic_graph_emit_owner.pgy,src/self_hosted/codegen/emission/expr_semantic_call_emit_owner.pgy,src/self_hosted/codegen/emission/expr_semantic_identity_bound_call_emit_owner.pgy,src/self_hosted/codegen/emission/option_value_emit_owner.pgy,src/self_hosted/codegen/emission/collection_element_emit_owner.pgy,src/self_hosted/semantic/ast_expression_graph_view_owner.pgy,src/self_hosted/semantic/ast_body_call_target_resolution_owner.pgy,src/self_hosted/semantic/ast_body_role_operator_resolution_owner.pgy,src/self_hosted/semantic/ast_expression_identity_resolution_owner.pgy,src/self_hosted/semantic/ast_expression_place_fact_owner.pgy,src/self_hosted/semantic/ast_capability_fact_owner.pgy | TypedAstArenaAtomText,TypedAstArenaValueText,TypedAstArenaAuxValueText,ContainsCallOutsideStrings,CodegenExpressionUsageFactsFromArena,CodegenAstArenaExpressionPartsAt,FindTopLevelPlus,RewriteBool,RewriteIndexing,RewriteInoutCallArgs,ExprSequenceItemAt,generic_return_text_inference,codegen_generic_graph_rescan,expr_semantic_shape_emit_owner,callable_type_from_text,callable_target_name_dispatch,SemanticAstIntentExpressionOwnerNodeId,SemanticAstArtifactAnalyzeCompactBridge,SemanticAstExpressionSurfaceFactsFromArtifactCompactBridge,SemanticExpressionGraphBuildCompactBridgeFromText,SemanticAstExpressionVerdictFromPayload,expression_graph_text_type_fallback,expr_binding_rewrite_owner.pgy,expr_rewrite.pgy,literal_rewrite.pgy,struct_value_emit.pgy,expr_scan.pgy,expr_sequence_owner.pgy,struct_field_access_owner.pgy,struct_literal_call_owner.pgy,struct_literal_field_owner.pgy,codegen_parser_implementation_import | tests/self_hosted/parity/expression_surface_closure_probe_parity.sh#CLOSED selfhost.expression_surface fallbacks:,tests/self_hosted/parity/driver_rung2_body_parity.sh#producer-first source/MIR parity ok,tests/self_hosted/parity/driver_rung2_nested_generic_containers_parity_owner.sh#List<T> contextual construction and fail-closed ABI negatives,tests/self_hosted/parity/driver_rung2_callable_parameter_identity_owner.sh#callable identity C/LLVM runtime parity + exact negative ratchet: PASS,tests/self_hosted/parity/callable_parameter_installed_self_host_owner.sh#public C/LLVM callable substitution + native runtime oracle: PASS,tests/self_hosted/parity/intent_capability_fact_owner.sh#10 native-C identity/missing-row controls PASS | CLOSED | none
selfhost.semantic_artifact_admission | semantic | AstTreeArtifactIdentityDigest | SFSemanticAstArtifactAdmission | SOSemanticArtifact | src/self_hosted/semantic/ast_artifact_verdict_owner.pgy | SemanticAstArtifactAnalyzeFromExpressionSurfaces | src/self_hosted/semantic/ast_body_analysis_admission_owner.pgy,src/self_hosted/semantic/ast_body_type_bundle_owner.pgy,src/self_hosted/semantic/ast_named_value_boundary_verdict_owner.pgy,src/self_hosted/semantic/ast_zone_value_carriage_verdict_owner.pgy,src/self_hosted/semantic/ast_zone_parameter_boundary_verdict_owner.pgy,src/self_hosted/codegen/emission/program_admitted_semantic_owner.pgy,src/self_hosted/codegen/emission/program_entry_owner.pgy,src/self_hosted/codegen/emission/program_emit.pgy,src/self_hosted/compiler/driver_pipeline_owner.pgy,src/self_hosted/compiler/driver_rung2_owner.pgy,src/self_hosted/compiler/canonical_mir_execution_owner.pgy,src/self_hosted/semantic/ast_expression_carried_callable_identity_owner.pgy,src/self_hosted/codegen/emission/expr_semantic_identity_bound_call_emit_owner.pgy | emission_whole_artifact_semantic_reconstruction,identity_from_node_count_only,emission_digest_recalculation,admitted_path_checked_fallback,admitted_body_constructor_rows_revalidation,malformed_body_parallel_row,raw_analysis_without_deep_proof,timeout_as_correctness,callable_identity_reconstructed_after_admission,callable_builtin_name_override,backend_named_value_boundary_rejection_as_source_semantics,backend_zone_value_carriage_rejection_as_source_semantics,backend_zone_parameter_rejection_as_source_semantics,single_threaded_zone_copy_compatibility,single_threaded_zone_parameter_by_value_compatibility,owned_sequence_type_named_boundary_allowlist,canonical_mir_constructor_fact_reconstruction | tests/self_hosted/parity/direct_mir_array_named_value_boundary_owner.sh#native/self Array family rejection + named/default/copy-only controls: PASS,tests/self_hosted/parity/direct_mir_owned_sequence_named_value_boundary_owner.sh#native/self List+Queue rejection + named/default controls + native fresh constructors: PASS,tests/self_hosted/parity/semantic_expression_environment_owned_lifetime_smoke.sh#semantic admission repeats an unbounded artifact proof,tests/self_hosted/parity/semantic_expression_environment_owned_lifetime_smoke.sh#admitted body reopens checked constructor rows,tests/self_hosted/parity/semantic_expression_environment_owned_lifetime_smoke.sh#direct codegen seed lost its one-analysis admitted path,src/self_hosted/semantic/ast_artifact_verdict_contract_owner.pgy#stale_same_count,src/self_hosted/semantic/ast_artifact_verdict_contract_owner.pgy#stale_same_tree,src/self_hosted/semantic/ast_body_analysis_admission_contract_owner.pgy#malformed_parallel_shape,tests/self_hosted/parity/compiler_internal_builtin_caller_provenance_owner.sh#common caller registry and parser-owned declaration module provenance reject exact wrong-path impersonation in C/LLVM legacy and artifact routes while the production driver bootstrap requires typed --source and rejects its parser/AST-text detour,tests/self_hosted/parity/domain_runtime_zone_sync_execution_owner.sh#A generated fresh local owns its hidden lock for the exact lexical scope.,tests/self_hosted/parity/domain_runtime_zone_value_carriage_admission_owner.sh#copy/reassignment semantic admission and backend error ratchet: PASS,tests/self_hosted/parity/domain_runtime_zone_parameter_admission_owner.sh#default identity native/self single/thread-safe parity + explicit ref + zone/world return rejection: PASS,tests/self_hosted/parity/default_c_compile_installed_self_host_owner.sh#installed self-host artifact owns plain C compile; host-only link is closed,tests/self_hosted/parity/default_llvm_installed_self_host_owner.sh#installed compiler intent artifact and canonical runtime own public LLVM compile/run,tests/self_hosted/parity/public_ast_installed_self_host_owner.sh#canonical composite priority AST identity,tests/self_hosted/parity/public_dir_installed_self_host_owner.sh#canonical composite priority DIR admission and non-Int rejection,tests/self_hosted/parity/driver_rung2_callable_parameter_identity_owner.sh#callable identity C/LLVM runtime parity + exact negative ratchet: PASS,tests/self_hosted/parity/callable_parameter_installed_self_host_owner.sh#public C/LLVM callable substitution + native runtime oracle: PASS,tests/self_hosted/parity/canonical_mir_verified_projection_owner.sh#canonical projection reopened constructor facts from the AST | ACTIVE | body materialization consumes one identity-and-row-shape receipt; admitted production consumers reuse constructor proof while arbitrary-pair wrappers retain the checked path; internal storage-retire caller identity is owned once by the common registry and parser-owned declaration module provenance reaches aligned semantic signatures, with consumer-local tuple and root-path guessing rejected; the production driver bootstrap consumes typed --source directly, while AST-text provenance remains unknown and compiler-internal calls fail closed; the installed C artifact, compile/link, and run targets consume the admitted compiler-root path with native semantic/codegen fallback deleted; released default-runtime LLVM now consumes the canonical runtime owner for the admitted host-I/O surface; canonical composite priority now reaches installed AST and full DIR with non-Int rejection; fresh direct local zone lock construction/destruction is generated across normal, return, break, and continue exits; local copy, reassignment, explicit own/unsupported mutable zone parameters, and zone-owning returns now fail closed in semantic admission before C publication, while default identity and explicit ref carriage execute in single and thread-safe C; a caller-owned fresh world carries exact embedded-zone resource paths and default/explicit inout identity through nested lock lifecycle, and both the backend embedding guard and backend zone-return guard are deleted; general zone transfer/move remains open; canonical MIR declaration-field rebinding consumes admitted constructor rows without AST reconstruction; canonical callable types and formal/declared callable identities now cross-seal syntax and binding IDs through installed C/LLVM while broader artifact admission stays ACTIVE
...
selfhost.call_target_identity | semantic | SyntaxNodeId | SFCallTargetIdentity | SOSemanticCallTarget | src/self_hosted/semantic/ast_expression_call_target_fact_owner.pgy | SemanticExpressionCallTargetFact | src/self_hosted/semantic/ast_expression_call_target_capture_owner.pgy,src/self_hosted/semantic/ast_expression_graph_resolved_call_type_owner.pgy,src/self_hosted/semantic/ast_expression_graph_concrete_scalar_verdict_owner.pgy,src/self_hosted/mir/expression_graph_fact_owner.pgy,src/self_hosted/codegen/emission/expr_semantic_call_emit_owner.pgy,src/self_hosted/compiler/driver_rung2_owner.pgy,src/self_hosted/semantic/ast_expression_carried_callable_identity_owner.pgy,src/self_hosted/codegen/emission/expr_semantic_identity_bound_call_emit_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_callable_parameter_identity_owner.pgy | callee_text_as_final_identity,namespace_name_join_fallback,codegen_receiver_type_method_join | tests/self_hosted/parity/initializer_projection_probe_parity.sh#missing-carried-direct-target,tests/self_hosted/parity/driver_rung2_list_ops_parity_owner.sh#missing List call target fails closed,tests/self_hosted/parity/driver_rung2_callable_parameter_identity_owner.sh#callable identity C/LLVM runtime parity + exact negative ratchet: PASS,tests/self_hosted/parity/vessel_method_argument_type_admission_owner.sh#graph-owned vessel method argument rejection, exact MIR/C/LLVM receipt, native identity, general-call distinction, and valid control | CLOSED | none
selfhost.collection_call_protocol | semantic | CollectionCallId | SFCollectionCallProtocol | SOCollectionCallProtocol | src/self_hosted/semantic/ast_expression_graph_collection_call_protocol_owner.pgy | SemanticExpressionGraphCollectionCallProtocolFromName | src/self_hosted/semantic/builtin_signature_owner.pgy,src/self_hosted/semantic/ast_expression_graph_resolved_call_type_owner.pgy,src/self_hosted/semantic/ast_expression_graph_queue_call_owner.pgy,src/self_hosted/semantic/ast_expression_graph_set_call_owner.pgy,src/self_hosted/semantic/ast_expression_graph_concrete_scalar_verdict_owner.pgy,src/self_hosted/semantic/ast_expression_verdict_owner.pgy,src/self_hosted/codegen/emission/expr_semantic_call_emit_owner.pgy,src/self_hosted/codegen/emission/expr_semantic_composite_literal_emit_owner.pgy,src/self_hosted/codegen/emission/list_call_type_owner.pgy,src/self_hosted/codegen/emission/queue_call_type_owner.pgy,src/self_hosted/codegen/emission/set_call_type_owner.pgy,src/self_hosted/codegen/emission/list_call_emit_owner.pgy,src/self_hosted/codegen/emission/queue_call_emit_owner.pgy,src/self_hosted/codegen/emission/set_call_emit_owner.pgy,src/self_hosted/codegen/emission/hashmap_call_type_owner.pgy,src/self_hosted/codegen/emission/hashmap_call_owner.pgy,src/self_hosted/codegen/runtime_abi/hashmap_runtime_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_hashmap_owner.pgy | collection_call_name_redeclaration,collection_call_arity_redeclaration,collection_call_argument_position_redeclaration,collection_call_return_shape_redeclaration,missing_collection_call_protocol_success | tests/self_hosted/parity/collection_call_protocol_owner_smoke.sh#shared collection call protocol owner and negative ratchet are wired,tests/self_hosted/parity/nested_collection_call_arity_semantic_admission_owner.sh#graph-owned nested SetSize arity rejects before MIR, exact public MIR/C receipt, native identity, and valid-call control | CLOSED | none
abi.hashmap_string_key_storage | abi | HashMapStringKeyStorageKind | SFHashMapStringKeyStorage | SOHashMapStringKeyStorage | src/common/hashmap_key_storage_kind.h | PGY_HASHMAP_KEY_STORAGE_STRING | src/codegen/codegen_hashmap_key_policy.c,src/codegen/llvm_expr_aggregate.c,src/codegen/llvm_expr_collection_base_calls.c,src/codegen/llvm_stmt_let_collections.c,src/codegen/transpiler_expr_composite_literal_emit.c,src/codegen/transpiler_expr_stdlib_map_builtin.c,src/runtime/pgy_runtime_builtin_hashmap_inline.h,src/runtime/pgy_runtime_builtin_storage_inline.h,src/runtime/pgy_runtime_lib_raw_map_exports.h,src/runtime/pgy_runtime_lib_raw_map_key_exports.h,src/runtime/pgy_runtime_lib_array_map_exports.h,src/runtime/pgy_runtime_map_int_key_inline.h,src/runtime/pgy_runtime_map_keys_inline.h,src/runtime/pgy_runtime_map_string_inline.h,src/self_hosted/codegen/runtime_abi/hashmap_key_abi_projection_owner.pgy,src/self_hosted/codegen/runtime_abi/hashmap_runtime_owner.pgy,src/self_hosted/codegen/runtime_abi/hashmap_llvm_runtime_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_llvm_hashmap_owner.pgy | borrowed_source_key_pointer,post_grow_key_duplication,partial_mapkeys_snapshot,mapkeys_on_invalid_storage,backend_local_string_key_policy | tests/hashmap_string_storage_runtime_smoke.sh#inline+generic+raw owned-key/grow/update/dup-OOM/quarantine-self-alias/MapKeys/exact-drop/mismatch PASS,tests/concept_semantics/hashmap_admission.sh#String-key Int/Long/Bool/String native/public C/LLVM parity 86/86 | CLOSED | none
abi.hashmap_runtime_release | abi | HashMapOwnedReleaseId | SFHashMapOwnedRelease | SOHashMapOwnedRelease | src/runtime/pgy_runtime_lib_raw_map_exports.h | pgy_map_drop_raw_impl | src/runtime/pgy_runtime_builtin_hashmap_inline.h,src/runtime/pgy_runtime_builtin_storage_inline.h,src/runtime/pgy_runtime_map_string_inline.h,src/codegen/llvm_runtime_raw_collections.c,src/self_hosted/codegen/runtime_abi/hashmap_runtime_owner.pgy,src/self_hosted/codegen/runtime_abi/hashmap_llvm_runtime_owner.pgy | value_type_blind_release,release_without_initialized_storage,duplicate_release_nonzero_descriptor,mapkeys_snapshot_backing_only_release | tests/hashmap_string_storage_runtime_smoke.sh#inline+generic+raw owned-key/grow/update/dup-OOM/quarantine-self-alias/MapKeys/exact-drop/mismatch PASS,tests/self_hosted/parity/hashmap_runtime_owner.sh#36 ABI/key/storage/release/header/negative controls PASS | CLOSED | none
semantic.hashmap_collection_ownership | semantic | CollectionBindingSyntaxId | SFCollectionOwnership | SOCollectionOwnership | src/semantic/collection_ownership_fact.c | semantic_collection_ownership_initialize_binding | src/semantic/type_checker_ownership_let.c,src/semantic/type_checker_builtins_stdlib_array.c,src/compiler/hir_semantic_fact_projection.c,src/compiler/mir_branch_source_facts.c,src/compiler/mir_json_dump.c,src/self_hosted/semantic/ast_collection_ownership_verdict_owner.pgy,src/self_hosted/mir/collection_ownership_fact_owner.pgy,src/self_hosted/mir_lower/collection_ownership_fact_owner.pgy,src/self_hosted/mir/json_projection_owner.pgy | descriptor_type_as_element_ownership,borrowed_string_literal_deep_drop,mapkeys_snapshot_shallow_copy,mapkeys_snapshot_shallow_mutation,unknown_origin_owned_promotion,unknown_provenance_deep_drop,mapget_string_borrow_escape,parameter_descriptor_drop,inout_descriptor_drop,returned_descriptor_drop,materialization_carrier_drop,nested_container_recursive_drop | tests/hashmap_owned_string_provenance_smoke.sh#borrowed drops, MapKeys shallow mutation/copy/double-drop refusals and owned-drop control PASS,tests/collection_ownership_fact_projection_smoke.sh#stable semantic -> HIR -> MIR rows and Symbol-owner deletion PASS,src/tests/mir/test_mir_collection_ownership_validation.cases.h#MIR collection ownership carrier rejects in-memory mutations,tests/self_hosted/parity/collection_ownership_fact_carrier_owner.sh#native/self-host producer-consumer parity and,tests/self_hosted/parity/collection_ownership_semantic_owner.sh#native fact -> installed self-host -> public C/LLVM ownership parity PASS | ACTIVE | Stable binding ownership rows now project through semantic, HIR, MIR, native JSON, self-host production, and both self-host readers. Native and self-host validators reject forged unknown-origin owned/retired rows instead of importing Slot, generation, pointer, spelling, or type authority. The row remains open because EMPTY and producer/transfer event receipts do not yet exist, UNKNOWN deep drop still fails open, MapGet<String> borrow escape plus parameter/return/inout/materialization/aggregate facts are absent, and exact-once CFG cleanup does not yet consume one plan in native/public C and LLVM.
abi.hashmap_int_key_storage | abi | HashMapIntKeyStorageKind | SFHashMapIntKeyStorage | SOHashMapIntKeyStorage | src/codegen/codegen_hashmap_key_policy.c | pgy_hashmap_key_storage_kind_from_name | src/codegen/llvm_expr_aggregate.c,src/codegen/llvm_expr_collection_base_calls.c,src/codegen/llvm_stmt_let_collections.c,src/codegen/transpiler_expr_composite_literal_emit.c,src/codegen/transpiler_expr_stdlib_map_builtin.c,src/runtime/pgy_runtime_builtin_hashmap_inline.h,src/runtime/pgy_runtime_builtin_storage_inline.h,src/runtime/pgy_runtime_lib_raw_map_exports.h,src/runtime/pgy_runtime_lib_raw_map_key_exports.h,src/runtime/pgy_runtime_lib_array_map_exports.h,src/runtime/pgy_runtime_map_int_key_inline.h,src/runtime/pgy_runtime_map_keys_inline.h,src/runtime/pgy_runtime_map_string_inline.h,src/self_hosted/codegen/runtime_abi/hashmap_runtime_owner.pgy,src/self_hosted/codegen/runtime_abi/hashmap_llvm_runtime_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_llvm_hashmap_owner.pgy | pgy_map_format_i32_key,pgy_map_i32_key_string_export | tests/hashmap_i32_storage_runtime_smoke.sh#collision/delete/grow/extremes/OOM/update-no-allocation/mismatch PASS | CLOSED | none
abi.hashmap_long_key_storage | abi | HashMapLongKeyStorageKind | SFHashMapLongKeyStorage | SOHashMapLongKeyStorage | src/common/hashmap_key_storage_kind.h | PGY_HASHMAP_KEY_STORAGE_I64 | src/codegen/codegen_hashmap_key_policy.c,src/codegen/llvm_expr_aggregate.c,src/codegen/llvm_expr_collection_base_calls.c,src/codegen/llvm_stmt_let_collections.c,src/codegen/transpiler_expr_composite_literal_emit.c,src/codegen/transpiler_expr_stdlib_map_builtin.c,src/runtime/pgy_runtime_builtin_hashmap_inline.h,src/runtime/pgy_runtime_builtin_storage_inline.h,src/runtime/pgy_runtime_lib_raw_map_exports.h,src/runtime/pgy_runtime_lib_raw_map_key_exports.h,src/runtime/pgy_runtime_lib_array_map_exports.h,src/runtime/pgy_runtime_map_int_key_inline.h,src/runtime/pgy_runtime_map_keys_inline.h,src/runtime/pgy_runtime_map_string_inline.h,src/self_hosted/codegen/runtime_abi/hashmap_runtime_owner.pgy,src/self_hosted/codegen/runtime_abi/hashmap_llvm_runtime_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_llvm_hashmap_owner.pgy | pgy_map_format_i64_key,pgy_map_i64_key_string_export,strtoll | tests/hashmap_i64_storage_runtime_smoke.sh#inline+raw collision/delete/grow/extremes/high-half-hash/OOM/update-no-allocation/mismatch PASS | CLOSED | none
abi.hashmap_bool_key_storage | abi | HashMapBoolKeyStorageKind | SFHashMapBoolKeyStorage | SOHashMapBoolKeyStorage | src/common/hashmap_key_storage_kind.h | PGY_HASHMAP_KEY_STORAGE_BOOL | src/codegen/codegen_hashmap_key_policy.c,src/codegen/llvm_expr_aggregate.c,src/codegen/llvm_expr_collection_base_calls.c,src/codegen/llvm_stmt_let_collections.c,src/codegen/transpiler_expr_composite_literal_emit.c,src/codegen/transpiler_expr_stdlib_map_builtin.c,src/runtime/pgy_runtime_builtin_hashmap_inline.h,src/runtime/pgy_runtime_builtin_storage_inline.h,src/runtime/pgy_runtime_lib_raw_map_exports.h,src/runtime/pgy_runtime_lib_raw_map_key_exports.h,src/runtime/pgy_runtime_lib_array_map_exports.h,src/runtime/pgy_runtime_map_int_key_inline.h,src/runtime/pgy_runtime_map_keys_inline.h,src/runtime/pgy_runtime_map_string_inline.h,src/self_hosted/codegen/runtime_abi/hashmap_key_abi_projection_owner.pgy,src/self_hosted/codegen/runtime_abi/hashmap_runtime_owner.pgy,src/self_hosted/codegen/runtime_abi/hashmap_llvm_runtime_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_llvm_hashmap_owner.pgy | pgy_map_format_bool_key,pgy_map_bool_key_string_export,invalid stored bool key | tests/hashmap_bool_storage_runtime_smoke.sh#inline+raw true/false/update/delete-reinsert/MapKeys/OOM/string-alias/mismatch PASS | CLOSED | none
...
projection.direct_mir_literal_log_plan | projection | VerifiedLiteralLogProjectionPlanId | SFDirectMirLiteralLogPlan | SOProjectionPlanner | src/self_hosted/compiler/direct_mir_literal_log_plan_owner.pgy | DirectMirLiteralLogPlanFromAdmitted | src/self_hosted/compiler/direct_mir_backend_projection_owner.pgy,src/self_hosted/compiler/direct_mir_literal_log_emission_owner.pgy | DirectMirHelloProjectionFromAdmitted,DirectMirHelloEmit,Arithmetic,expr0,direct_mir_literal_log_uppercase_only_read | tests/self_hosted/parity/one_mir_compile_time_declaration_literal_projection.sh#ability exact 7, zero-decl/rename/display equality, literal 73, and,tests/self_hosted/parity/lowercase_entrypoint_installed_self_host_owner.sh#semantic identity installed C/direct-public LLVM runtime and artifact-free negative ratchets | CLOSED | none
...
abi.mir_array_string_layout_projection | abi | ArrayStringLayoutProjectionId | SFAbiArrayStringLayoutProjection | SOMirAbi | src/self_hosted/compiler/direct_mir_array_string_abi_fact_owner.pgy | DirectMirArrayStringCapturedAbiReady | src/self_hosted/compiler/direct_mir_scalar_cfg_foreach_string_collection_owner.pgy,src/self_hosted/compiler/direct_mir_array_string_abi_projection_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_cfg_foreach_typed_c_emission_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_cfg_foreach_typed_llvm_emission_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_array_string_abi_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_array_string_abi_projection_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_array_string_mutation_projection_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_c_string_collection_materialization_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_c_process_args_materialization_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_c_array_string_storage_materialization_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_c_dir_walk_materialization_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_llvm_string_collection_materialization_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_llvm_process_args_materialization_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_llvm_array_string_storage_materialization_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_llvm_string_join_materialization_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_llvm_array_readonly_ref_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_llvm_array_value_parameter_storage_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_cfg_program_c_emission_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_cfg_program_llvm_emission_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_cfg_program_c_signature_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_c_payload_enum_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_c_array_string_value_result_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_llvm_array_string_value_result_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_owned_array_string_move_fact_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_owned_array_string_move_admission_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_array_string_cleanup_policy_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_c_array_string_literal_expression_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_llvm_array_string_literal_expression_owner.pgy,src/self_hosted/compiler/direct_mir_scalar_program_owned_array_string_move_flow_owner.pgy | backend_local_array_layout,layout_id_without_row_admission,array_runtime_symbol_guess,backend_string_element_reconstruction,capacity_as_length,post_issue_layout_mutation,scalar_program_preamble_layout_literal,complete_cross_family_row_acceptance,c_dir_walk_positional_array_string_layout,duplicate_scalar_program_array_string_projection_readiness,process_args_array_string_storage_alignment_literal,process_args_without_target_projection,llvm_readonly_ref_array_string_storage_alignment_literal,readonly_ref_array_string_without_target_projection,owner_handle_array_string_without_caller_move_fact,caller_cleanup_after_owner_handle_array_string_move,owner_handle_array_string_use_after_move,multiple_owner_moves_rejected_as_scalar_fact,orphan_or_repeated_consuming_expression,stale_owned_move_flow_receipt,duplicate_final_owned_move_cfg_proof | tests/self_hosted/parity/one_mir_mixed_collection_foreach_projection.sh#one typed receipt owns mixed Int/String foreach C/LLVM execution,tests/self_hosted/parity/direct_mir_scalar_bool_two_array_string_two_array_int_value_result_owner.sh#one carried target projection owns scalar preamble and value-result C/LLVM storage plus complete cross-family row rejection,tests/self_hosted/parity/one_mir_string_collection_builtin_projection.sh#target-projected scalar storage executes String/Array<String> builtins in C and LLVM,tests/self_hosted/parity/direct_mir_scalar_dir_walk_direct_call_owner.sh#C DirWalk consumes projected ArrayString fields and rejects layout drift,tests/self_hosted/parity/direct_mir_scalar_process_args_direct_call_owner.sh#Process Args consumes projected ArrayString storage alignment and rejects layout drift,tests/self_hosted/parity/direct_mir_scalar_array_string_readonly_ref_owner.sh#Read-only ArrayString parameter loads consume the carried LLVM projection and reject layout drift,tests/self_hosted/parity/direct_mir_scalar_owned_array_string_parameter_owner.sh#One last-use caller local moves into an owner-handle ArrayString parameter and C/LLVM reject use-after-move,tests/self_hosted/parity/direct_mir_scalar_non_entrypoint_owned_array_string_parameter_owner.sh#A non-entrypoint single-block local moves into an owner-handle ArrayString,tests/self_hosted/parity/direct_mir_owned_array_string_callee_identity_owner.sh#Callee-order permutation and independent returns preserve last-use C/LLVM moves with owned ABI and returned-use refusals,tests/self_hosted/parity/direct_mir_scalar_owned_array_string_return_owner.sh#Owned ArrayString return consumes target projection and exact cleanup in C/LLVM,tests/self_hosted/parity/direct_mir_scalar_multiple_owned_array_string_parameters_owner.sh#Multiple independent single-block owner moves consume one sealed row set and duplicate-local use fails closed,tests/self_hosted/parity/direct_mir_owned_array_string_terminal_flow_owner.sh#Consuming return/strict nested calls and continuations use one sealed flow proof,tests/self_hosted/parity/direct_mir_owned_array_string_terminal_flow_owner.sh#Complete consuming-exit sets and strict record operands own exact caller cleanup,tests/self_hosted/parity/direct_mir_owned_array_string_sealed_flow_owner.sh#A repaired outer digest cannot admit stale ownership coverage of typed flow | BRIDGE | local-literal foreach, scalar-program collection preamble and value-result storage, LLVM StringJoin, C DirWalk, process Args, the LLVM read-only parameter load, standalone owned return, and caller-local owner-handle moves consume admitted target projections through one complete consuming-exit-set proof, including strict consuming return graphs, admitted record-constructor operands and last-use continuations, independently of callee declaration order, owned-parameter ordinal and unrelated return values; partially consuming conditional owned-parameter moves, fresh-result or literal moves, ownership-return chains, conditional cleanup, and remaining non-literal expression materializers still require consumer migration
```
semantic.builtin_effect_policy | semantic | BuiltinFixedEffectId | SFBuiltinEffectPolicy | SOBuiltinEffectPolicy | src/semantic/builtin_effect_registry.def | PGY_BUILTIN_EFFECT_POLICY_ROWS | src/semantic/type_checker_helpers_effects.c,src/self_hosted/semantic/builtin_effect_projection_owner.pgy,src/self_hosted/semantic/ast_capability_call_graph_owner.pgy | capability_bits_as_effects,missing_fixed_effect_as_pure,renderer_only_effect_admission,scalar_callee_mask_as_complete_effects | tests/concept_semantics/effect_admission.sh#owned refusal,tests/builtin_effect_registry_smoke.sh#fixed builtin effect registry smoke: ok | CLOSED | none
<!-- END sot-owner-spine-registry -->

## Language word registry closed — 2026-09-26

`lexer.language_word_registry` is `CLOSED`. `PGY_LANGUAGE_WORD_REGISTRY_ROWS`
in `src/lexer/language_keyword_registry.def` owns all 146 language words:
their stable `LanguageWordId`, class, contexts, declared support, tooling and
highlight scope. The native lexer and parser, the self-host projection, LSP
completion and hover, and the TextMate grammar read those rows. The parser
half closed in the last two series:

- Every self-host parser owner selects a word through `MatchLanguageWord` and
  a `LanguageWordId`. The raw-selector census used to scan three variable
  names in four owners; it now scans every parser owner and any comparison.
  It found five more text selectors: the intent rollback policy compared
  `current`, `none` and `full`, the routine head word reached `Expect` as a
  string, and a literal probe compared `"true"`. All five read the registry.
- Every word a native parser selects, the self-host parser selects too. The
  inventory's native-only count went from 29 to 0, and
  `tests/language_keyword_registry_smoke.sh` requires 0. On the way the
  self-host parser learned world members, zone slot groups and effect pools,
  the effect-clause words, `innate`, duration literals, and the parallel join
  header with its six join modes. The statement form `parallel (x in xs) { }`
  had been skipped to the first `;`, so its closing brace ended the enclosing
  block; it now prints native's tree.
- Where native parses a form this parser does not, the parser refuses at the
  word with a code. Before, it read the word as a name and blamed the token
  after it.
  - `select` statements, `pin` blocks, `expr is Type`, `reflect X`, and
    intent `rollback: current` or `rollback: none` refuse with
    `surface_not_covered`.
  - `give VALUE` refuses with `give_outside_parallel_join`. It is legal only
    in an expression-form join body, which this parser keeps as one leaf, so
    native refuses every `give` this parser reaches.
  - `default_route_diagnostic_position_owner.sh` pins each refusal at its
    line, and native's column for the join header and `give`.
- `every` and `continuous` were declared supported by both front ends, yet
  both refuse the role reactive block at `parallel` (a docs/181 vision
  surface). Native read the two words only while recovering from that error.
  The recovery now skips the block whole, and the registry declares no
  implementation for them.

What stays outside the row is scope, not a fallback. The default route does
not run `select`, `pin`, type tests, `reflect`, the two rollback policies or
expression-form join bodies; each is refused by identity at its word, and
covering one is default-route work, not word identity.

## Runtime-call ABI rows closed — 2026-09-25

`abi.runtime_call_rows` is `CLOSED`. `mir_abi_resource_runtime_row_for_type_name`
in `src/compiler/mir_abi_resource_runtime.c` owns which runtime function a
Slot/SecureSlot/DeviceSlot operation calls, its call shape and its stable id.
MIR copies the row into each resource instruction and declaration field
claim; the C and LLVM backends read it from there, and LLVM module-level
scalar declarations read the static table by type name through
`llvm_runtime_declaration_row`.

Removed on the way:

- `mir_abi_resource_runtime_row_by_kind` and `mir_abi_resource_runtime_fn_by_kind`.
  The constructed-row generator is internal to the owner and runs only after
  the static table missed.
- The C and LLVM kind-based lookups, which ran only without MIR. A backend
  without MIR now fails closed; AST-only unit tests expect that error, and the
  slot sugar, pin and secure view cases compile real source through MIR.
- The payload default for a claimed class field. An argument-free
  `ClaimSlot()` field passed semantics, then MIR used Int and the backends
  failed without a code. Semantics refuses it with `PGY_SEM_INFER_REQUIRED`.

The self-host copy of the spelling rule is now checked against the owner.
`test-mir` already compared the committed `runtime_call_abi` artifact's
150 native-resource rows with the native table; the artifact now also lists
the constructed rows for four probe payloads (a plain nominal, a nested
generic, a generic with a comma and a space, and one past the 96-byte suffix
limit), and `test-mir` requires every listed row to equal the owner's row,
id included, and every row the owner produces for a probe to be listed.
Changing one self-host symbol or dropping one row fails that test.

What stays outside the row is scope, not a fallback: a Slot over a nominal
payload has no layout row, and the backends' acceptance of that absence for
constructed rows is an `abi.layout_rows` item.

## Function parameter flow summary closed — 2026-09-25

`semantic.function_param_flow_summary` is `CLOSED`. The demanded owner in
`src/semantic/function_param_flow_summary.c` is the only producer of a
parameter's read/write/release/escape mask. The slot analyzer's access and
escape walkers ask it at every call site, and the ownership call contract asks
it through `function_param_flow_summary_for_param`.

Deleted in this closure:

- `slot_analyze_legacy_ast_param_summary_in_program`, whose context-free
  branch walked the whole function body instead of asking the owner. Its one
  caller, `semantic_callable_param_escape_summary`, now calls the owner.
- `slot_analyze_escape_flags` and `slot_analyze_escape_flags_in_program`,
  context-free entry points with no caller, and `slot_param_summary_in_program`,
  the whole-body walker only they reached.
- The program-root name scan in `slot_analyzer_find_function_decl`. Every
  lookup carries a `SemanticContext`, so a callee resolves through the
  semantic host index or not at all.
- The `depth` parameter of the access and escape walkers. Nothing ever
  incremented it, so its `depth > 6` guards (one returned "no access") could
  only have truncated a summary. The owner's per-demand work budget fails
  closed with a diagnostic instead.

`tests/function_param_flow_summary_smoke.sh` names all six fallbacks next to
the checks that keep them closed. Two new unit tests execute the attachment
refusals: `test_hir` rejects a summary row whose function identity names no
HIR routine, and `test_air` checks that the MIR validator and the AIR collector
both refuse rows on a routine without a stable identity. Removing either
refusal fails its test. `tests/hir_function_param_flow_summary_smoke.sh` had
been failing since the HIR lowering call moved out of `driver_app.c`; it now
checks `hir_semantic_fact_projection.c`.

What stays outside the row is scope, not a fallback:

- `semantic_callable_param_escape_summary` still subtracts from the owner's
  answer when the callee's body summary proves no ref escape or no channel
  send. Both proofs are narrower facts about the same callee, not a second
  producer. `BODY_SUMMARY_MAY_ESCAPE_REF` is itself recorded from this owner's
  masks.
- The self-host MIR writers emit no summary rows. The self-host front end
  refuses the programs these rows describe before MIR (`Slot<T>`
  initialization from a value is `let_type_mismatch` there), and every
  direct-MIR lane refuses a routine that carries the rows. A self-host
  producer is a separate substitution rung.

## Builtin fixed-effect policy closed — 2026-09-23

`semantic.builtin_effect_policy` is `CLOSED`. The row owns the fixed intrinsic
effects in `src/semantic/builtin_effect_registry.def` and nothing wider; its
stable handle is `BuiltinFixedEffectId`. All three named consumers are
fail-closed. Native `semantic_record_builtin_effect` reads the registry rows
and reports a semantic error for a name that has none. The self projection is
rendered from the registry with no private rows, checked byte for byte, and
answers -1 for an absent name. The self call graph turns -1 into unknown
effects instead of reading a scalar mask as the whole set.

`tests/concept_semantics/effect_admission.sh` names all four fallbacks next to
the checks that keep them closed, and `tests/builtin_effect_registry_smoke.sh`
asserts each consumer's refusal path. The effect gate used to be a manual
concept experiment that the registry cited without CI running it; it is now
the push step `make effect-admission-test-smoke` in the Linux self-host shard
and left the manual gate inventory (94 checks, about 15 seconds). The native half of
`missing_fixed_effect_as_pure` is new: replacing that semantic error with a
silent return now fails the smoke. `IsCancelled` moved from a native-only case
into the shared cases, so its `remote` refusal is the owned
`declared_effect_missing` diagnostic on native, on the self driver and before
publication on both public backends.

What stays outside the row is scope, not a fallback:

- Resource builtins (channels, device slots, slot operations, ownership
  allocation, qubit claim and release) and the `await` construct record their
  effects in their own native owners. This row neither claims nor projects
  them, and public call facts carry explicit unknowns for them.
- Callback builtins (`ArrayMap`, `ArrayFilter`) take their effect from the
  callback, and the smoke forbids classifying them as fixed.
- The self-host checker has no quantum builtin signatures, so it refuses
  `Measure` programs with `undefined_function` before the effect rule runs.
  The gate keeps that refusal fail-closed on the self driver and both public
  backends; the case joins the shared ones once the self refusal is the owned
  effect diagnostic.
- Known call effects are lower bounds, not whole-language purity proofs.

## Enum declaration rows closed — 2026-09-23

`selfhost.enum_declaration_rows` is `CLOSED`. The last reachable old reader was
the lightweight semantic checker, which projected enum variant callable rows by
scanning the concatenated source bundle. That owner now parses the checked
source with the parser owner and reads `SemanticAstEnumFacts`; comma-optional
variants, payload labels and enum methods are the parser's answer, and the
component contract rejects every text-scan helper in that owner by name
(`lightweight_checker_source_enum_projection`). A source that declares no enum
is not parsed, because the checker still accepts statement shapes the self-host
parser does not cover; the word `enum` only decides whether the parser is asked,
never what an enum is.

Closing the row required the self-host parser to accept a method inside an enum
body, which it refused before; `parser_parity.sh` now holds 190 fixtures
byte-equal with the native AST printer, including a method declared between two
variants.

What remains is execution coverage, not an owner fallback: the installed
direct-MIR slice substitutes one payload-free ordinal value and identity-match
CFG through the shared plan, while payload enums and general enum execution stay
with the direct-MIR projection rungs
(`tests/self_hosted/parity/one_mir_enum_value_match_projection.sh`).

## Active Zone/World default-identity evidence — 2026-09-20

`selfhost.semantic_artifact_admission` remains `ACTIVE`; this bounded bridge
does not promote the row. A default-mode Zone or World parameter is an
automatic identity reference, while explicit `ref` remains readonly and
explicit `own` still requires a transfer plan. The MIR parameter row owns that
distinction as `mutable-identity/indirect` versus `readonly-ref/indirect`;
direct-MIR consumers may not derive a second carriage from nominal spelling.

`tests/self_hosted/parity/domain_runtime_zone_identity_direct_mir_owner.sh`,
which is sourced by the row's zone-sync witness, executes default Zone and
embedded-Zone World parameters through the installed public C and LLVM paths,
checks the single-pointer C ABI, and mutates each carried row to
`value/direct`. The mutants must fail before a partial artifact is published.
General Zone transfer/move and broader semantic artifact admission remain the
next open boundary.
...
## Readonly String call-duration consumer — 2026-09-04

This bounded repair leaves both `abi.layout_rows` and
`projection.direct_mir_scalar_cfg_program_extension` at `BRIDGE`.
`CompilerAbiLayoutRowOwnershipShapeAt` owns the borrowed-String-view direct C
pass fact. Source-C definitions and prototypes consume that fact as one
`const char*`; semantic call-argument emission separately requires an exact
...
For direct MIR, `DirectMirRoutineSignatureFact` retains type, carriage,
resource, pass shape, ABI requirement, and return identity. The callable
parameter policy admits the exact row, the role plan preserves
`readonly-ref`, and
`DirectMirScalarProgramVoidReadonlyStringTargetAt` projects only the sealed
routine-partition target consumed by direct-call carriage and both emitters.
The installed gate executes exact `leftright` through source/direct/public C
and LLVM and rejects escaping return plus carriage/resource/pass/ABI/return
drift without an artifact or native retry.

This adds no authority or hard-substitution numerator. Census remains
88 authorities / 185 derived carriers and `55/32/1`; the separate
`resource.region_allocation_plan` row remains open because String concat still
uses its existing heap materialization. Module Build remains design-only until
self-host closure, evidence compression, and a real external workload.

## Bounded direct role-override consumer — 2026-09-04

This repair adds no authority and does not promote a registry row. The existing
`selfhost.role_declaration_rows` owner now distinguishes a direct role-owned
`override func` from an ability implementation method and projects that fact
into `SelfMirDeclarationRows`. The three-routine direct-MIR boundary then
admits exact declaration, routine, SyntaxNodeId, literal, construction, and
subject-bound call identity before issuing one target-neutral plan. C and LLVM
both preserve the role body as a distinct callable, but an ordinary subject
member call remains bound to the subject method.

The signature owner records whether the source declared the receiver as its
first untyped `self` parameter with an exact 0/1 offset. Source-C definitions,
prototypes, environment rows, semantic member/generic calls, and
`CodegenImplicitReceiverCParameterOrDie` consume that fact; none may infer it
again from the visible parameter name. The sealed plan also carries nominal ABI
evidence into one target projection, so direct C/LLVM emitters do not hard-code
field layout or receiver types. The focused gate proves installed/public/native
AST and canonical-MIR parity, eight role C/LLVM runtime legs with exact `base`,
three receiver runtimes with exact `42`, three order permutations, ten
artifact-free MIR negatives, and fourteen source negatives. Its adjacent
struct-argument comparison
normalizes only repository-root and producer-local positive SyntaxNodeId
spellings while retaining the ABI receipt comparison and fifteen mutations.

`semantic.callable_receiver_carriage` and `mir.execution_graph` therefore stay
`BRIDGE`. The executable registry checker owns the current census; this
historical receiver evidence does not pin a second progress count.
Exact remote CI is still required before this local candidate is published.
...
src/self_hosted/mir/collection_ownership_fact_owner.pgy | SelfMirCollectionOwnershipFactRowsAppendRoutine | semantic.hashmap_collection_ownership | projection
src/self_hosted/mir_lower/collection_ownership_fact_owner.pgy | BuildMirCollectionOwnershipFacts | semantic.hashmap_collection_ownership | projection
src/self_hosted/mir/intent_execution_fact_owner.pgy | MirIntentExecutionPlanFromFacts | mir.execution_graph | projection
src/self_hosted/mir/intent_zone_authority_transition_fact_owner.pgy | MirIntentZoneAuthorityTransitionFactsReady | selfhost.zone_authority_rows | projection
src/self_hosted/compiler/direct_mir_intent_completion_fact_owner.pgy | DirectMirIntentCompletionFact | mir.execution_graph | projection
...
src/self_hosted/compiler/direct_mir_identity_cell_fact_owner.pgy | DirectMirIdentityCellFacts | projection.direct_mir_scalar_cfg_program_extension | local_view
...
src/self_hosted/semantic/ast_expression_verdict_fact_owner.pgy | SemanticAstExpressionVerdict | selfhost.expression_surface | local_view
...
src/self_hosted/compiler/direct_mir_scalar_program_record_abi_fact_owner.pgy | DirectMirScalarProgramRecordAbiCarriage | abi.layout_rows | projection
...
Current status counts: `CLOSED=68 BRIDGE=25 ACTIVE=2`.

`selfhost.expression_surface` is closed. Parser-owned expression rows now carry
supported scalar, call, aggregate, generic, wrapper, collection, and place
topology through semantic admission and codegen. The compact artifact/surface/
graph bridges and codegen text-rewrite owners are deleted; an unsupported but
structurally valid graph node fails at `expression_graph_type` instead of
falling back to payload-text typing. The primary closure gate owns those
deletion and missing-fact ratchets, while focused hard DRV-2 parity supplies
production execution evidence. This promotion changes the census by exactly
one row from `BRIDGE` to `CLOSED`; it does not promote
`selfhost.semantic_artifact_admission` or `diagnostic.catalog`.
...
bijection and host-compiles. A fresh direct local zone also owns generated lock
init/destroy across normal, return, break, and continue exits and executes the
same result in single-threaded and thread-safe C. This bounded hidden-resource
slice is `SUBSTITUTING`; it does not add a fixed source/world lifetime.

The wider domain-runtime slice remains `REACHABLE`. The zero-topology
semantic-artifact receipt must not replace the admitted nonzero direct-MIR
plan. Named copy, reassignment, by-value parameter/return, and world embedding
still lack an admitted lock-transfer plan; their thread-safe C paths fail
closed, so zone transfer and composite-intent full DIR admission remain open.
The focused negative/execution owner is
