...
# (self_hosted/tools/air_graph_json_validator/main.pgy).
...
PERGYRA_TOOL_SOURCE="$ROOT_DIR/self_hosted/tools/air_graph_json_validator/main.pgy"
PERGYRA_TOOL_BUILD_DIR="${PGY_SELFHOST_BUILD_DIR:-$ROOT_DIR/.tmp/self_hosted/air_graph_json_validator}"
PERGYRA_TOOL="$PERGYRA_TOOL_BUILD_DIR/main.pgy"
EXPECTED_JSON_FILE="$ROOT_DIR/self_hosted/tools/air_graph_json_validator/expected/clean.json"
FIXTURE_FILE="$ROOT_DIR/self_hosted/tools/air_graph_json_validator/fixture/sample.json"
...
mkdir -p "$NEG_ROOT/self_hosted/tools/air_graph_json_validator/fixture"
# Strip the "summary":{...}, segment - simple sed that matches the live shape.
sed -E 's/"summary":\{[^}]*\},//' "$FIXTURE_FILE" \
    > "$NEG_ROOT/self_hosted/tools/air_graph_json_validator/fixture/sample.json"
