...
# (self_hosted/tools/module_manifest_resolver/main.pgy).
...
PERGYRA_TOOL_SOURCE="$ROOT_DIR/self_hosted/tools/module_manifest_resolver/main.pgy"
PERGYRA_TOOL_BUILD_DIR="${PGY_SELFHOST_BUILD_DIR:-$ROOT_DIR/.tmp/self_hosted/module_manifest_resolver}"
PERGYRA_TOOL="$PERGYRA_TOOL_BUILD_DIR/main.pgy"
EXPECTED_JSON_FILE="$ROOT_DIR/self_hosted/tools/module_manifest_resolver/expected/clean.json"
...
# in the live tree is at `self_hosted/tools/<tool>/main.pgy`, and its import
# resolves to `self_hosted/lib/`. The build dir mirrors this two-level
...
cp "$ROOT_DIR/self_hosted/lib/"*.pgy "$LIB_BUILD_DIR/"
