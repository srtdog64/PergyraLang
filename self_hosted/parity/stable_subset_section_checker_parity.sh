...
#
# Pergyra is the origin (self_hosted/tools/stable_subset_section_checker/main.pgy).
...
PERGYRA_TOOL_SOURCE="$ROOT_DIR/self_hosted/tools/stable_subset_section_checker/main.pgy"
PERGYRA_TOOL_BUILD_DIR="${PGY_SELFHOST_BUILD_DIR:-$ROOT_DIR/.tmp/self_hosted/stable_subset_section_checker}"
PERGYRA_TOOL="$PERGYRA_TOOL_BUILD_DIR/main.pgy"
EXPECTED_JSON_FILE="$ROOT_DIR/self_hosted/tools/stable_subset_section_checker/expected/clean.json"
