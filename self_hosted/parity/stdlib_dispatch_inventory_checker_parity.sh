...
PERGYRA_TOOL_SOURCE="$ROOT_DIR/self_hosted/tools/stdlib_dispatch_inventory_checker/main.pgy"
PERGYRA_TOOL_BUILD_DIR="${PGY_SELFHOST_BUILD_DIR:-$ROOT_DIR/.tmp/self_hosted/stdlib_dispatch_inventory_checker}"
PERGYRA_TOOL="$PERGYRA_TOOL_BUILD_DIR/main.pgy"
EXPECTED_JSON_FILE="$ROOT_DIR/self_hosted/tools/stdlib_dispatch_inventory_checker/expected/clean.json"
...
# Mirror self_hosted/lib/ -> .tmp/lib/ so the tool's
