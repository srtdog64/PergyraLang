...
The 600-LOC split-review threshold (`TODO.md §0. 코어 규칙`) is a beta-
...
- **manifest_owner**:
  `self_hosted/tools/production_header_size_checker/fixture/headers_manifest.txt`
...
```json
{
  ...
  "ok": true,
  "source": {
    "manifest_owner": "self_hosted/tools/production_header_size_checker/fixture/headers_manifest.txt",
    "cap_lines": 600
  },
  "counts": {
    "headers": 0,
