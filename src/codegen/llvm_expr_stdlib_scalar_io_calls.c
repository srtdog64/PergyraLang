...
llvm_stdlib_string_file_runtime_call_lookup(const char *callee_name)
{
    static const LLVMStdlibRuntimeCallSpec kLLVMStdlibStringFileRuntimeSpecs[] = {
        ...
        { "SubContains", "stdlib string", "SubContains", 4 },
        { "SubContainsWithLen", "stdlib string", "SubContainsWithLen", 5 },
        { "SubEquals", "stdlib string", "SubEquals", 4 },
        { "SubEqualsWithLen", "stdlib string", "SubEqualsWithLen", 5 },
        { "SubIndexOf", "stdlib string", "SubIndexOf", 4 },
        { "SubIndexOfWithLen", "stdlib string", "SubIndexOfWithLen", 5 },
