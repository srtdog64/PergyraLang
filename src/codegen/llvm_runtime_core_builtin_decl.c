...
llvm_declare_runtime_core_builtins(LLVMGenCtx *ctx)
{
...

    {
        struct {
            ...
            { "SubstringWithLen", ctx->type_i8ptr,
              { ctx->type_i8ptr, ctx->type_i32, ctx->type_i32, ctx->type_i32 }, 4 },
            ...
            { "pgy_char_from_code", ctx->type_i8ptr,
              { ctx->type_i32 }, 1 },
            { "pgy_try_read_file_export", ctx->type_i1,
              { ctx->type_i8ptr, LLVMPointerType(ctx->type_i8ptr, 0),
                LLVMPointerType(ctx->type_i32, 0) }, 3 },
            { "pgy_try_write_file_export", ctx->type_i1,
              { ctx->type_i8ptr, ctx->type_i8ptr,
                LLVMPointerType(ctx->type_i32, 0) }, 3 },
            ...
            { "StringConcat", ctx->type_i8ptr,
              { ctx->type_i8ptr, ctx->type_i8ptr }, 2 },
            { "pgy_region_create_export", ctx->type_void,
              { LLVMPointerType(ctx->type_region, 0), ctx->type_i64 }, 2 },
            { "pgy_region_destroy_export", ctx->type_void,
              { LLVMPointerType(ctx->type_region, 0) }, 1 },
            { "pgy_region_string_concat_export", ctx->type_i8ptr,
              { LLVMPointerType(ctx->type_region, 0),
                ctx->type_i8ptr, ctx->type_i8ptr }, 3 },
            ...
            { "pgy_budget_wall_arm_export", ctx->type_void,
              { 0 }, 0 },
            { "pgy_machine_layer_runtime_bind_export", ctx->type_i32,
              { ctx->type_i64, ctx->type_i64 }, 2 },
            { "pgy_machine_layer_runtime_bind_mapping_export", ctx->type_i32,
              { ctx->type_i64, ctx->type_i64, ctx->type_i64,
                ctx->type_i64, ctx->type_i32, ctx->type_i32 }, 6 },
            ...
            { "SeedRandom", ctx->type_void,
              { ctx->type_i32 }, 1 },
            { "pgy_compiler_artifact_abort", ctx->type_i32,
              { ctx->type_i32 }, 1 },
            { "pgy_compiler_artifact_begin", ctx->type_i32,
              { ctx->type_i8ptr }, 1 },
            { "pgy_compiler_artifact_commit", ctx->type_i32,
              { ctx->type_i32 }, 1 },
            { "pgy_compiler_artifact_write", ctx->type_i1,
              { ctx->type_i32, ctx->type_i8ptr }, 2 },
