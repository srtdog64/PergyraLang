...
bool transpiler_call_arg_can_take_subject_address(TranspilerCtx *ctx,
                                                  ASTNode *arg_node);
bool transpiler_call_arg_is_indirect_ref(TranspilerCtx *ctx,
                                         ASTNode *arg_node);
bool transpiler_call_arg_is_carried_by_address(TranspilerCtx *ctx,
                                               ASTNode *arg_node);
