...
compiler_runtime_cache_is_fresh(const char *cache_obj_path)
{
    ...
    const char *deps[] = {
        ...
        PGY_RUNTIME_DIR "/pgy_runtime_lib_part_b_part_a.inc",
        PGY_RUNTIME_DIR "/pgy_runtime_lib_part_b_part_b.inc",
        PGY_RUNTIME_DIR "/pgy_runtime_lib_part_b_part_c.inc",
        PGY_RUNTIME_DIR "/pgy_runtime_lib_part_b_part_d.inc",
        PGY_RUNTIME_DIR "/pgy_runtime_lib_part_b_part_e.inc",
        PGY_RUNTIME_DIR "/pgy_runtime_lib_part_b_part_f.inc",
        PGY_RUNTIME_DIR "/pgy_runtime_part_a.inc",
        PGY_RUNTIME_DIR "/pgy_runtime_part_b.inc",
        PGY_RUNTIME_DIR "/pgy_runtime_part_ba.inc",
        PGY_RUNTIME_DIR "/pgy_runtime_part_ba_part_a.inc",
        PGY_RUNTIME_DIR "/pgy_runtime_part_ba_part_b.inc",
        PGY_RUNTIME_DIR "/pgy_runtime_part_ba_part_c.inc",
        PGY_RUNTIME_DIR "/pgy_runtime_part_ba_part_d.inc",
        PGY_RUNTIME_DIR "/pgy_runtime_part_ba_part_e.inc",
        PGY_RUNTIME_DIR "/pgy_runtime_part_ba_part_f.inc",
