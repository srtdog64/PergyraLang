...
static const MIRTextBuilderRuntimeRow k_text_builder_rows[] = {
    { "TextBuilderAppend", "Append", "pgy_text_builder_append",
    ...
    { "TextBuilderDrop", "Drop", "pgy_text_builder_drop",
    ...
    { "TextBuilderFinish", "Finish", "pgy_text_builder_finish",
      "pgy_text_builder_finish_export",
      MIR_TEXT_BUILDER_CALL_BUILDER_ALLOCATOR_TO_STRING,
      MIR_TEXT_BUILDER_CALL_BUILDER_ALLOCATOR_TO_STRING,
      "mir_builtin_abi_row" },
    { "TextBuilderNew", "New", "pgy_text_builder_new",
