...
pgy_intent_subject_fingerprint(void **subjects, int32_t subject_count)
{
...
static inline int32_t
pgy_intent_find_free_active_slot(void)
{
...
static inline void
pgy_intent_note_free_active_slot(int32_t slot)
{
                        ...
                        bool is_concurrent, int32_t priority)
{
    ...
    subject_fingerprint =
        pgy_intent_subject_fingerprint(subjects, subject_count);
    ...
    free_index = pgy_intent_find_free_active_slot();
