/* =================================================================
 * Channel<String> Result export adapters.
 * ================================================================= */

#ifndef PGY_RUNTIME_LIB_CHANNEL_STRING_RESULT_EXPORTS_H
#define PGY_RUNTIME_LIB_CHANNEL_STRING_RESULT_EXPORTS_H
...
char *
pgy_channel_recv_val_String(PgyChannel_String_RT *ch)
{
    PgyRuntimeChannelStringResult result =
...
#endif /* PGY_RUNTIME_LIB_CHANNEL_STRING_RESULT_EXPORTS_H */
