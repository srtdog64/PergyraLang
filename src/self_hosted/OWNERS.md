...
- `src/self_hosted/codegen/runtime_abi/spawn_runtime_owner.pgy` -- bounded self-host C spawn/await runtime ABI facts for direct `Int -> Int` async work, including `Future<Int>` handle materialization; unsupported spawn shapes fail closed.
