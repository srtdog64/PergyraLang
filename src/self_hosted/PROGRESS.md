...
**Compiler-internal substitution: ~3.81% direct owner-file LOC-scale** (9,707 Pergyra LOC vs 254,742
...
**first codegen rungs** (`src/self_hosted/codegen/`, 2695 LOC; rung-0 string Log,
...
| **Total**       | **254742** |   **9707**  | **~3.81% direct owner-file LOC-scale** | lexer/parser/semantic + codegen rung-0..16; MIR JSON lowering is tracked separately above |
