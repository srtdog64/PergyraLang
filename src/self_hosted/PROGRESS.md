...
6. **C-emit codegen subset** -- *rung-0..15 active* (2026-06-17). A Pergyra
   ...
   `Ok`/`Err`/`IsOk`/`IsErr`/`Unwrap`/`UnwrapOr`, `Exit(n)`,
   ...
   on 52 committed fixtures, with the emitter built through both backends. Next
