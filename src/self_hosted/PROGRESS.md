...
6. **C-emit codegen subset** -- *rung-0..15 active* (2026-06-17). A Pergyra
   ...
   `Array<Int>` `ArraySort`/`ArrayMap`/`ArrayFilter`, `Exit(n)`,
   ...
   on 51 committed fixtures, with the emitter built through both backends. Next
