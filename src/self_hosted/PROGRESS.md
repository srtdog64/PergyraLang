...
from `ArrayPush` or other statement text. The real-source semantic selfcheck now accepts 121
...
4. **Semantic subset** -- *rung-2 active* (2026-06-23). The current rung
  ...
  real-source selfcheck now feeds 121 accepted self-host owner/source files
