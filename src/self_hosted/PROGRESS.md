...
collection. `program_emit` also consumes typed arena kind/atom predicates for
declaration routing, Main/event checks, and top-level function selection.
The rest of codegen,
...
`gen2 == gen3` byte-identical (last observed 7474 generated-C lines) -- and the
