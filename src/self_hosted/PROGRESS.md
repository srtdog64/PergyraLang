...
from `ArrayPush` or other statement text. The real-source semantic selfcheck now accepts 120
...
diagnostic payload, LSP-1 squiggle-policy projection, and LSP-2a..LSP-2h
buffered transport/request/response/session/document-state/feature-shape/session-state rungs
(docs/150).
...
4. **Semantic subset** -- *rung-2 active* (2026-06-23). The current rung
  ...
  real-source selfcheck now feeds 120 accepted self-host owner/source files
