...
**Compiler-internal substitution: ~3.81% direct owner-file LOC-scale** (9,717 Pergyra LOC vs 254,742
...
| **Total**       | **254742** |   **9717**  | **~3.81% direct owner-file LOC-scale** | lexer/parser/semantic + codegen rung-0..16; MIR JSON lowering is tracked separately above |
