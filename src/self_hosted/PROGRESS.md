...
**Compiler-internal substitution: ~5.89% direct owner-file LOC-scale** (14,666 Pergyra LOC vs 248,794
...
**first codegen rungs** (`src/self_hosted/codegen/`, 3,844 LOC; rung-0 string Log,
...
resource owners visible. The real-source semantic selfcheck now accepts 80
...
| **Total**       | **248794** |  **14666**  | **~5.89% direct owner-file LOC-scale** | lexer/parser/semantic + codegen rung-0..20; MIR JSON lowering and compiler-world contracts are tracked separately above |
...
4. **Semantic subset** -- *rung-2 active* (2026-06-23). The current rung
  ...
  real-source selfcheck now feeds 80 accepted self-host owner/source files
