...
byte-equal output vs `pgy --ast` on **107 of 119** committed
`examples/*.pgy` files (89.9%). Four files byte-drift on deferred
...
3. **Parser bootstrap** -- *expanding* (2026-06-18). `src/self_hosted/parser/`
   ...
   generated by both C and LLVM, and **107 of 119** `examples/*.pgy` files at
