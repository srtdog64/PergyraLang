...
4. **Semantic subset** -- *rung-2 active* (2026-06-23). The current rung
   ...
   real-source selfcheck now feeds 73 accepted self-host owner/source files
   ...
   owner, semantic run/program/body/call/expression owner files, and audit-tool
