...
for the receiver and pushed expression. `ArraySet` and `For` compound payloads
remain bridge-owned until their multi-field payloads have row-shaped typed arena
facts.
The rest of codegen,
...
`gen2 == gen3` byte-identical (last observed 7226 generated-C lines) -- and the
