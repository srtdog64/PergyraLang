...
**Compiler-internal substitution: ~5.90% direct owner-file LOC-scale** (14,677 Pergyra LOC vs 248,794
...
**first codegen rungs** (`src/self_hosted/codegen/`, 3,855 LOC; rung-0 string Log,
...
| **Total**       | **248794** |  **14677**  | **~5.90% direct owner-file LOC-scale** | lexer/parser/semantic + codegen rung-0..20; MIR JSON lowering and compiler-world contracts are tracked separately above |
