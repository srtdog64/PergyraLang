...
aux-value rows for receiver, index, and assigned value. `For` remains
bridge-owned until its multi-field payloads have row-shaped typed arena facts.
The rest of codegen,
...
`gen2 == gen3` byte-identical (last observed 7319 generated-C lines) -- and the
