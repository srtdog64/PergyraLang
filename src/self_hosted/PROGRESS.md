...
collection. `program_emit` consumes typed arena kind/atom predicates for
declaration routing, and `function_emit` uses them for collector prepasses.
The rest of codegen,
...
`gen2 == gen3` byte-identical (last observed 7480 generated-C lines) -- and the
