...
static Type *
helpers_effects_resolve_type_ref(ASTNode *type_ref, SemanticContext *ctx)
{
        ...
        if (field != NULL && field->name != NULL
            ...
            if (field_type_out != NULL)
                *field_type_out = field->type != NULL
                    ? helpers_effects_resolve_type_ref(field->type, ctx)
                    : TYPE_UNKNOWN;
            return 1;
        }
    }
