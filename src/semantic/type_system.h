...
size_t type_constructed_arg_count(const Type* type);
Type* type_constructed_arg(const Type* type, size_t index);
Type* type_get_constructed_arg(const Type* type, size_t index);
bool type_constructed_is(const Type* type, const Type* constructor,
                         size_t arg_count);
...
Type* type_slot_inner_type(const Type* type);
