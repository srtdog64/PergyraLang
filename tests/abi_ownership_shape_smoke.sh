...
reject_term "src/codegen/llvm_internal_api.h" "llvm_mir_emit_borrow_view_alias"
reject_term "src/codegen/llvm_mir_block_emit.c" "llvm_mir_emit_borrow_view_alias"
reject_term "src/codegen/llvm_mir_resource_view.c" "llvm_mir_emit_borrow_view_alias"
require_term "src/codegen/llvm_mir_block_emit.c" "llvm_mir_bind_resource_view_def_alias("
require_term "src/codegen/llvm_mir_resource_view.c" "LLVM MIR resource view alias '%s' requires source slot metadata"
require_term "src/codegen/llvm_mir_resource_view.c" "LLVM MIR resource view alias '%s' cannot resolve source slot '%s'"
