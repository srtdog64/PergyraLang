...
require_term "src/codegen/llvm_runtime.c" "pgy_pin_read_%s"
...
require_term "src/codegen/llvm_mir_block_emit.h" "pgy_unpin_%s"

require_term "src/compiler/mir_cleanup_fact_names.h" "pin-unpin-cleanup-edge"
require_term "src/compiler/mir_cfg_contract_pin.h" "MIR_CLEANUP_FACT_PIN_UNPIN_EDGE"
require_term "src/compiler/mir_cfg_contract_validate.h" "pin-region block[%zu] missing pin-unpin cleanup fact"
