...
require_term "src/codegen/transpiler_expr_dispatch_emit.c" "mir_abi_resource_runtime_fn_by_kind("
require_term "src/codegen/transpiler_expr_dispatch_emit.c" "C expression slot %s requires MIR ABI runtime function row"
...
reject_term "src/codegen/transpiler_expr_dispatch_emit.c" "pgy_write_%s(%s, %s)"
reject_term "src/codegen/transpiler_expr_dispatch_emit.c" "pgy_secure_write_%s(%s, %s, &%s)"
