...
require_text "docs/semantics/pass_contract_manifest.md" "mir_decl_bootstrap_parity | src/codegen/llvm_decl.c | tests/mir_declaration_inventory_smoke.sh,tests/mir_decl_field_kind_vocabulary_smoke.sh,tests/self_hosted/parity/driver_rung2_effect_declaration_parity_owner.sh | gate-backed"
...
require_text "docs/semantics/pass_contract_manifest.md" "dir_zone_runtime_topology | src/compiler/dir_collect_domain.c | tests/domain_runtime_topology_smoke.sh,tests/self_hosted/parity/domain_topology_admission_owner.sh | gate-backed-partial"
