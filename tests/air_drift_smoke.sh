...
run_literal_air_drift_smoke() {
    ...
    require_literal "src/compiler/air_boundary.c" "air_intent_compression_budget"
    ...
    require_literal "src/compiler/air_validate.c" "air_validate_capability_machine"
    require_literal "src/compiler/air_validate.c" "slot site count without slot site array"
    require_literal "src/compiler/air_validate.c" "effect site count without effect site array"
    require_literal "src/compiler/air_boundary.c" "air_boundary_required_ability_storage_valid"
    require_literal "src/compiler/air_validate.c" "required ability count without abilities"
    require_literal "src/compiler/air_validate.c" "empty required ability"
    require_literal "src/compiler/air_validate.c" "capability %s is missing from program capability mask"
    require_literal "src/compiler/air_evidence_mir.c" "AIR MIR evidence failed to collect slot identity sites"
    require_literal "src/compiler/air_evidence_mir.c" "AIR MIR evidence failed to collect effect sites"
    ...
    require_literal "src/compiler/air_validate_global_evidence.c" "kGlobalEvidencePolicies"
    require_literal "src/compiler/air_validate_global_evidence.c" "air_global_evidence_policy_for_kind"
    require_literal "src/compiler/air_validate_global_evidence.c" "exact_fact_count_required"
    ...
    require_literal "src/compiler/air_internal.h" "AIREvidenceKindScope"
    require_literal "src/compiler/air_evidence_node.c" "AIR_EVIDENCE_SCOPE_BOUNDARY"
    require_literal "src/compiler/air_evidence_node.c" "AIR_EVIDENCE_SCOPE_GLOBAL"
    require_literal "src/compiler/air_evidence_node.c" "if (!kEvidenceKindMeta[kind].present)"
    require_literal "src/compiler/air_evidence_node.c" "air_evidence_kind_scope_matches_boundary_index"
    ...
    require_literal "src/test_air.c" "AIR verify rejects source provenance shape drift"
    require_literal "src/test_air.c" "AIR validates capability machine slot/effect facts"
    require_literal "src/test_air.c" "AIR rejects missing required ability inventory"
    require_literal "src/tests/air/test_air_core_part_h.cases.h" "test_air_rejects_effect_site_outside_program_capability_mask"
    require_literal "src/tests/air/test_air_core_part_h.cases.h" "test_air_rejects_empty_required_ability_fact"
    require_literal "src/tests/air/test_air_core_part_h.cases.h" "test_air_validates_capability_machine_slot_effect_facts"
    require_literal "src/compiler/air_validate.c" "action-inherited source provenance on non-zone boundary"
    require_literal "src/compiler/air_validate.c" "transfer source provenance on non-zone/world boundary"
    ...
    require_literal "src/test_air.c" "AIR append rejects boundary evidence without boundary index"
    require_literal "src/test_air.c" "AIR append rejects global evidence with boundary index"
...
required_evidence_shape_terms = [
    ...
    (air_impl, "carries boundary shape", "AIR global evidence boundary-shape rejection"),
...
required_test_terms = [
    ...
    "AIR parallel boundary requires RIR and HIR evidence",
    ...
    "AIR synthesis keeps local intent authority aliases",
