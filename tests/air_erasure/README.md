...
snapshot values include `04_channel_parallel` `A_inh=3`,
`phys_Sync_excess=11`; `05_zone_intent` `A_inh=2`, `phys_Sync_excess=2`;
`06_lifecycle_branch` `C_unprov=1`; and `08_secure_slot_method` `B_pol=2`.
