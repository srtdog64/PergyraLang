...
run_literal_doc_contract_smoke() {
    ...
    require_literal "src/compiler/mir_types.h" "requires_source_local_decl_emit"
    require_literal "src/compiler/mir_types.h" "requires_select_receive_statement_emit"
    require_literal "src/compiler/mir_types.h" "MIR_INST_DESTRUCTURE"
    require_literal "src/compiler/mir_types.h" "destructure_binding_names"
    require_literal "src/compiler/mir.h" "mir_instruction_destructure_binding_index"
    require_literal "src/compiler/mir_types.h" "MIR_INST_ASSIGN"
    ...
    require_literal "src/compiler/mir_types.h" "is_select_case_body"
...
mir_intent_path = root / "src" / "compiler" / "mir_intent_step_emit.c"
