...
required_files=(
    ...
    "docs/semantics/25_hir_routine_identity.md"
...
systems_identity_terms=(
    ...
    "A declaration is attribution evidence"
    "Authorization and delegability are separate facts."
    "complete mediation"
    "capability-envelope confinement"
    "Resource/Slot layer"
    "Machine Layer"
    "Resource identity does not determine an address"
