...
@t0 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@t1 = private unnamed_addr constant [46 x i8] c"  +=========================================+\00", align 1
@t2 = private unnamed_addr constant [45 x i8] c"  |  Pergyra Programming Language          |\00", align 1
@t3 = private unnamed_addr constant [45 x i8] c"  |  Meet Gyri, the Nautilus.              |\00", align 1
@t4 = private unnamed_addr constant [45 x i8] c"  |                                        |\00", align 1
...
define void @Main() {
bb_0:
  call void @pgy_log_int(i32 0)
  call void @pgy_log_string(ptr @t0)
  call void @pgy_log_string(ptr @t1)
  call void @pgy_log_string(ptr @t2)
  call void @pgy_log_string(ptr @t3)
  call void @pgy_log_string(ptr @t4)
  call void @pgy_log_string(ptr @t5)
