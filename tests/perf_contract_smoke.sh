...
grep -Fq "mir_abi_resource_runtime_fn_by_kind(" "$ROOT_DIR/src/codegen/transpiler_slot_runtime_row.c"
grep -Fq "C expression slot %s requires MIR ABI runtime function row" "$ROOT_DIR/src/codegen/transpiler_slot_runtime_row.c"
