...
grep -Fq "requires an identifier receiver" "$ROOT_DIR/src/codegen/llvm_expr_call_collections_extended.c"
grep -Fq "requires registered %s local" "$ROOT_DIR/src/codegen/llvm_expr_call_collections_extended.c"
