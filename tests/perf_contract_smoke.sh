...
grep -Fq "pergyra_ast_type_to_c_copy_in_ctx(ctx, param_type" "$ROOT_DIR/src/codegen/transpiler_event_emit.c"
...
grep -Fq "entry == &frame->entries[index]" "$ROOT_DIR/src/codegen/llvm_stmt_parallel_async.c"
