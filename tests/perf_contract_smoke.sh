...
grep -Fq "MIR_STMT still carries generic AST-backed statements" "$ROOT_DIR/src/codegen/intent_observability_usage.c"
grep -Fq "pgy_decl_methods_use_intent_observability" "$ROOT_DIR/src/codegen/intent_observability_usage.c"
