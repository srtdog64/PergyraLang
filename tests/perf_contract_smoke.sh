...
grep -Fq "case AST_ROLE_DECL:" "$ROOT_DIR/src/codegen/llvm_inventory_decl_lookup.c"
grep -Fq "case AST_PARTY_DECL:" "$ROOT_DIR/src/codegen/llvm_inventory_decl_lookup.c"
grep -Fq "case AST_ROSTER_DECL:" "$ROOT_DIR/src/codegen/llvm_inventory_decl_lookup.c"
grep -Fq "AST_PARTY_DECL, name" "$ROOT_DIR/src/codegen/llvm_inventory_decl_lookup.c"
grep -Fq "AST_ROLE_DECL, name" "$ROOT_DIR/src/codegen/llvm_inventory_decl_lookup.c"
grep -Fq "AST_ROSTER_DECL, name" "$ROOT_DIR/src/codegen/llvm_inventory_decl_lookup.c"
...
grep -Fq "LLVM MIR secure pin requires registered runtime function" "$ROOT_DIR/src/codegen/llvm_mir_block_emit.c"
grep -Fq "LLVM MIR pin requires registered runtime function" "$ROOT_DIR/src/codegen/llvm_mir_block_emit.c"
grep -Fq "LLVM MIR pin cleanup requires registered runtime function" "$ROOT_DIR/src/codegen/llvm_mir_block_emit.c"
