...
grep -Fq "mir_abi_resource_runtime_fn_by_kind(" "$ROOT_DIR/src/codegen/transpiler_slot_builtin_emit.c"
...
grep -Fq "mir_abi_resource_runtime_fn_by_kind(" "$ROOT_DIR/src/codegen/transpiler_expr_dispatch_emit.c"
grep -Fq "C expression slot %s requires MIR ABI runtime function row" "$ROOT_DIR/src/codegen/transpiler_expr_dispatch_emit.c"
! grep -Fq "pgy_write_%s(%s, %s)" "$ROOT_DIR/src/codegen/transpiler_expr_dispatch_emit.c"
! grep -Fq "pgy_secure_write_%s(%s, %s, &%s)" "$ROOT_DIR/src/codegen/transpiler_expr_dispatch_emit.c"
...
grep -Fq "C slot method %s requires MIR ABI runtime function row" "$ROOT_DIR/src/codegen/transpiler_expr_call_member_emit.c"
...
grep -Fq "mir_abi_resource_runtime_fn_by_kind(" "$ROOT_DIR/src/codegen/transpiler_let_slot_emit.c"
...
grep -Fq "C source with-slot %s requires MIR ABI runtime function row" "$ROOT_DIR/src/codegen/transpiler_func_class_flow_emit.c"
...
grep -Fq "C class field slot Claim requires MIR ABI runtime function row" "$ROOT_DIR/src/codegen/transpiler_class_decl_emit.c"
