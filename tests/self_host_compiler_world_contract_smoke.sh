...
require_text "src/self_hosted/compiler/driver_source_c_request_owner.pgy" "enum DriverSourceCRequest"
forbid_text "src/self_hosted/compiler/driver_source_c_protocol_owner.pgy" "enum DriverSourceCRequest"
...
require_text "src/self_hosted/compiler/world.pgy" "self.direct_mir.execution.ProduceMirC("
require_text "src/self_hosted/compiler/compiler_world_direct_mir_owner.pgy" "func ProduceMirCThroughPgyCompilerWorld("
require_text "src/self_hosted/compiler/driver_mir_c_stdout_execution_owner.pgy" "ProduceMirCThroughPgyCompilerWorld("
require_text "src/self_hosted/compiler/driver_mir_c_stdout_execution_owner.pgy" "DriverRung2MirCPayloadAdmissionReadyFor("
require_text "src/self_hosted/compiler/driver_rung2_execution_owner.pgy" "action PublishMirCArtifact("
require_text "src/self_hosted/compiler/driver_rung2_execution_owner.pgy" "action ProduceMirC("
require_text "src/self_hosted/compiler/driver_mir_c_payload_execution_owner.pgy" "CompileMirJsonToCVerified("
require_text "src/self_hosted/compiler/driver_mir_c_payload_execution_owner.pgy" "CompileMirJsonToCVerifiedObserved("
forbid_text "src/self_hosted/compiler/driver_rung2_execution_owner.pgy" "CompileMirJsonToCVerified("
forbid_text "src/self_hosted/compiler/driver_rung2_cli_read_execution_owner.pgy" "CompileMirJsonToCVerified("
forbid_text "src/self_hosted/compiler/driver_mir_c_stdout_execution_owner.pgy" "CompileMirJsonToCVerified("
forbid_text "src/self_hosted/compiler/driver_mir_c_stdout_execution_owner.pgy" "SelfMirArtifactCommitPayload("
...
for term in \
    ...
    "ArrayLength(SemanticDiagnosticVocabularyRows()) != SemanticDiagnosticCodeCount()" \
