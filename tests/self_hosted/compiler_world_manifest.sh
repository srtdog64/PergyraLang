...
PGY_SELFHOST_COMPILER_SANDBOX_CAPABILITY_PATH="src/self_hosted/compiler/sandbox_capability_owner.pgy"
PGY_SELFHOST_COMPILER_SANDBOX_CAPABILITY_MANIFEST_PATH="src/self_hosted/compiler/sandbox_capability_manifest.pgy"
PGY_SELFHOST_COMPILER_COMPATIBILITY_EVOLUTION_PATH="src/self_hosted/compiler/compatibility_evolution_owner.pgy"
...
PGY_SELFHOST_COMPILER_TEST_HARNESS_MANIFEST_PATH="src/self_hosted/compiler/test_harness_manifest.pgy"
...
PGY_SELFHOST_COMPILER_BACKEND_ABI_LAYOUT_CONTRACT_PATH="src/self_hosted/compiler/backend_abi_layout_contract_owner.pgy"
PGY_SELFHOST_COMPILER_ABI_LAYOUT_TARGET_POLICY_PATH="src/self_hosted/compiler/abi_layout_target_policy_owner.pgy"
PGY_SELFHOST_COMPILER_ABI_LAYOUT_ROW_MANIFEST_PATH="src/self_hosted/compiler/abi_layout_row_manifest.pgy"
...
PGY_SELFHOST_COMPILER_DRIVER_PIPELINE_PATH="src/self_hosted/compiler/driver_pipeline_owner.pgy"
PGY_SELFHOST_COMPILER_DRIVER_BOOTSTRAP_MAIN_PATH="src/self_hosted/compiler/driver_bootstrap_main.pgy"
...
PGY_SELFHOST_COMPILER_WORLD_MANIFEST_PATHS=(
    ...
    "$PGY_SELFHOST_COMPILER_SANDBOX_CAPABILITY_PATH"
    "$PGY_SELFHOST_COMPILER_SANDBOX_CAPABILITY_MANIFEST_PATH"
    "$PGY_SELFHOST_COMPILER_COMPATIBILITY_EVOLUTION_PATH"
    "$PGY_SELFHOST_COMPILER_AIR_EVIDENCE_PATH"
    "$PGY_SELFHOST_COMPILER_ARTIFACT_ZONE_PATH"
    "$PGY_SELFHOST_COMPILER_TEST_HARNESS_PATH"
    "$PGY_SELFHOST_COMPILER_TEST_HARNESS_MANIFEST_PATH"
    "$PGY_SELFHOST_COMPILER_SUBPROCESS_RUNNER_PATH"
    "$PGY_SELFHOST_COMPILER_ABI_LAYOUT_ROW_PATH"
    "$PGY_SELFHOST_COMPILER_BACKEND_ABI_LAYOUT_CONTRACT_PATH"
    "$PGY_SELFHOST_COMPILER_ABI_LAYOUT_TARGET_POLICY_PATH"
    "$PGY_SELFHOST_COMPILER_ABI_LAYOUT_ROW_MANIFEST_PATH"
    "$PGY_SELFHOST_COMPILER_SYMBOL_TABLE_PATH"
    "$PGY_SELFHOST_COMPILER_STAGE_ARTIFACT_PATH"
    "$PGY_SELFHOST_COMPILER_AUTHORITY_PATH"
    "$PGY_SELFHOST_COMPILER_DRIVER_PIPELINE_PATH"
    "$PGY_SELFHOST_COMPILER_DRIVER_BOOTSTRAP_MAIN_PATH"
