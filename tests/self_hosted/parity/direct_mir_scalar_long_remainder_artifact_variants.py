...
if backend == "c":
    ...
    values = {
        ...
        "int-positive":
            'printf("%lld\\n", pgy_scalar_routine_2(100LL, 7LL));',
        "int-minimum-minus-one":
            'printf("%lld\\n", pgy_scalar_routine_2('
            '(-9223372036854775807LL - 1), -1LL));',
        "int-zero-divisor":
            'printf("%lld\\n", pgy_scalar_routine_2(100LL, 0LL));',
    }
elif backend == "llvm":
    pattern = (
    ...
    def llvm_call(routine, left, right):
        return (
            "  %pgy.remainder = call i64 @pgy.scalar.routine."
            f"{routine}("
    ...
    values = {
        "positive": llvm_call(1, "100", "7"),
        "minimum-minus-one": llvm_call(1, "-9223372036854775808", "-1"),
        "zero-divisor": llvm_call(1, "100", "0"),
        "int-positive": llvm_call(2, "100", "7"),
        "int-minimum-minus-one": llvm_call(
            2, "-9223372036854775808", "-1"),
        "int-zero-divisor": llvm_call(2, "100", "0"),
    }
else:
