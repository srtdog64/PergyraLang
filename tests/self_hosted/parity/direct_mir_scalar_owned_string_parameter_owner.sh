...
WORK_REL=".tmp/self_hosted/direct_mir_scalar_owned_string_parameter"
WORK_DIR="$ROOT_DIR/$WORK_REL"
SOURCE_REL="tests/self_hosted/fixtures/direct_mir_owned_string_parameter.pgy"
...
for mutation in owned-string-parameter-carriage owned-string-parameter-type \
    owned-string-parameter-pass owned-string-drop-call-target; do
