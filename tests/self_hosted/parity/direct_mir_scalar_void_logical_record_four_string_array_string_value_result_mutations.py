...
def main():
    ...
    routine = next(row for row in document["routines"] if row.get("name") == "AppendTypedBinding")
    ...
    if kind == "copyout-carriage":
        ...
        params[1]["type"] = "MissingTypedValueEnv"
        params[1]["abi_type_name"] = "MissingTypedValueEnv"
        ...
        params[3]["type"] = "MissingScalar"
        params[3]["abi_type_name"] = "MissingScalar"
