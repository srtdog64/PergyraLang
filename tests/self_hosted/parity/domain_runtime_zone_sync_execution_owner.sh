...
source "$ROOT_DIR/tests/self_hosted/parity/domain_runtime_world_zone_carriage_admission_owner.sh"
source "$ROOT_DIR/tests/self_hosted/parity/domain_runtime_zone_identity_direct_mir_owner.sh"
