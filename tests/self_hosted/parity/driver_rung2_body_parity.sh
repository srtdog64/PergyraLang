...
source "$ROOT_DIR/tests/self_hosted/parity/driver_rung2_mir_producer_parity_owner.sh"; source "$ROOT_DIR/tests/self_hosted/parity/driver_rung2_action_contract_parity_owner.sh"; source "$ROOT_DIR/tests/self_hosted/parity/driver_rung2_effect_declaration_parity_owner.sh"; source "$ROOT_DIR/tests/self_hosted/parity/driver_rung2_indexed_assignment_parity_owner.sh"; source "$ROOT_DIR/tests/self_hosted/parity/driver_rung2_assignment_binding_mode_parity_owner.sh"
