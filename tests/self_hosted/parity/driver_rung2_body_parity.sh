...
if [[ "${#mir_fixture_rows[@]}" -ne 276 ]]; then
    echo "[self-host-parity:driver-rung2] MIR fixture count drifted: ${#mir_fixture_rows[@]} != 276" >&2
    exit 1
fi
