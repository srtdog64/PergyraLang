...
require_text "while descending && build.ok"
require_text "SelfMirIfElseNestedIfRoot("
require_text "SelfMirLocalPredecessorSnapshotsAppend("
require_text "while frame_index >= 0"
require_text "MIR else-if frame cardinality drifted"
