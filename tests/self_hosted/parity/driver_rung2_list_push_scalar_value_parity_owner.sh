...
pgy_selfhost_verify_driver_rung2_list_push_scalar_value() {
    ...
    pgy_replace_first_literal "$self_mir_json" "$missing_edge" \
        '"kind":"multiply","text":"i * i","call_target_kind":"none","call_target_name":"","left":4,"right":5' \
        '"kind":"multiply","text":"i * i","call_target_kind":"none","call_target_name":"","left":4,"right":null'
