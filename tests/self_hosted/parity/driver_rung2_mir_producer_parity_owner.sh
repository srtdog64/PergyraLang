...
pgy_selfhost_run_driver_rung2_mir_producer_parity() {
    ...
    for fixture_rel in "${mir_fixture_rows[@]}"; do
        ...
        pgy_selfhost_verify_driver_rung2_fieldless_class "$backend" "$base" "$self_mir_json" "$driver_bin"; pgy_selfhost_verify_driver_rung2_spawn_await "$backend" "$base" "$self_mir_json" "$driver_bin"; pgy_selfhost_verify_driver_rung2_generic_spawn "$backend" "$base" "$self_mir_json" "$driver_bin"; pgy_selfhost_verify_driver_rung2_generic_string_spawn "$backend" "$base" "$self_mir_json" "$driver_bin"; pgy_selfhost_verify_driver_rung2_generic_spawn_mixed "$backend" "$base" "$self_mir_json"
        ...
        pgy_selfhost_verify_driver_rung2_spawn_await_emitted_c "$backend" "$base" "$self_actual"; pgy_selfhost_verify_driver_rung2_generic_spawn_emitted_c "$backend" "$base" "$self_actual"; pgy_selfhost_verify_driver_rung2_generic_string_spawn_emitted_c "$backend" "$base" "$self_actual"; pgy_selfhost_verify_driver_rung2_generic_spawn_mixed_emitted_c "$backend" "$base" "$self_actual"
