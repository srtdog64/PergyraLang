...
def main() -> int:
    ...
    cases = {
        ...
        "missing-method-id": lambda d: d["decls"][0]["methods"][0].pop("source_syntax_id"),
        "zero-method-id": lambda d: d["decls"][0]["methods"][0].update(source_syntax_id=0),
        "string-method-id": lambda d: d["decls"][0]["methods"][0].update(source_syntax_id="7"),
