...
EXCLUDED_FIXTURES="bad_condition_not_bool bad_not_operand"
...
echo "[self-host-public-logical-operand-json-diagnostic] exact binary-operand identity, five semantic contexts, MIR/C/LLVM relay, and condition/unary exclusion: PASS"
