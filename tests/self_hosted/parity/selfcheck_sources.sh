...
SELF_SOURCES=(
    ...
    "src/self_hosted/compiler/test_harness_air_graph_paths_owner.pgy"
    "src/self_hosted/compiler/test_harness_driver_paths_owner.pgy"
    ...
    "src/self_hosted/lexer/fixture_manifest_owner.pgy"
    ...
    "src/self_hosted/lexer/run_owner.pgy"
    ...
    "src/self_hosted/mir_lower/fixture_manifest_owner.pgy"
    ...
    "src/self_hosted/mir_lower/run_owner.pgy"
    ...
    "src/self_hosted/parser/fixture_manifest_owner.pgy"
