...
require_text "src/self_hosted/compiler/abi_layout_row_owner.pgy" 'import "target_capability_owner.pgy";'
...
require_text "src/self_hosted/compiler/abi_layout_row_owner.pgy" "func CompilerAbiLayoutTargetPolicyCount"
require_text "src/self_hosted/compiler/abi_layout_row_owner.pgy" "func CompilerAbiLayoutTargetPolicyAbiAt"
require_text "src/self_hosted/compiler/abi_layout_row_owner.pgy" "func CompilerAbiLayoutTargetPolicyProjectionSetAt"
require_text "src/self_hosted/compiler/abi_layout_row_owner.pgy" "func CompilerAbiLayoutTargetPolicyRequiredFactsAt"
...
require_text "src/self_hosted/compiler/abi_layout_row_owner.pgy" "CompilerAbiLayoutTargetPolicyAbiAt(0) == CompilerAbiLayoutSelfHostedCAbi()"
require_text "src/self_hosted/compiler/abi_layout_row_owner.pgy" "CompilerTargetProjectionKnown(CompilerTargetCpuCProjection())"
require_text "src/self_hosted/compiler/abi_layout_row_owner.pgy" "CompilerTargetProjectionKnown(CompilerTargetSelfHostedProjection())"
require_text "src/self_hosted/compiler/abi_layout_row_owner.pgy" "CompilerTargetFactKnown(CompilerTargetLayoutShapeFact())"
...
require_text "src/self_hosted/compiler/expected/runtime_call_abi_rows.txt" "64|string|substring|pgy_substr|function|generated_runtime_helper"
require_text "src/self_hosted/compiler/expected/runtime_call_abi_rows.txt" "82|host-io|exit|exit|function|target_library"
