...
require_text "src/self_hosted/codegen/input/ast_usage_owner.pgy" "CodegenAstArenaBuiltinCallPresent(arena, count, \"Args\")"
...
require_text "src/self_hosted/codegen/emission/stmt_emit.pgy" "let rexpr: String = CodegenAstArenaAtomOrDie(arena, idx)"
...
require_text "src/self_hosted/codegen/emission/stmt_emit.pgy" "let q_arr: String = CodegenAstArenaAtomOrDie(arena, idx)"
...
require_text "src/self_hosted/codegen/emission/stmt_emit.pgy" "let e_arg: String = CodegenAstArenaAtomOrDie(arena, idx)"
...
require_text "src/self_hosted/codegen/emission/stmt_emit.pgy" "let cond2: String = WrapCond(CodegenAstArenaAtomOrDie(arena, idx), env_box[0])"
...
require_text "src/self_hosted/codegen/emission/stmt_emit.pgy" "let match_subject: String = CodegenAstArenaAtomOrDie(arena, idx)"
require_text "src/self_hosted/codegen/emission/stmt_emit.pgy" "let case_pattern: String = CodegenAstArenaAtomOrDie(arena, cur[0])"
require_text "src/self_hosted/codegen/emission/stmt_emit.pgy" "let call_expr: String = CodegenAstArenaAtomOrDie(arena, idx)"
