...
require_text "src/self_hosted/tools/backend_emitter_contract_checker/expected/clean.json" '"required":12'
...
require_text "src/self_hosted/compiler/abi_layout_row_owner.pgy" "CompilerAbiLayoutConcreteRowCount() == 16"
...
require_text "src/self_hosted/compiler/abi_layout_row_owner.pgy" "CompilerAbiLayoutRowTypeNameAt(12) == CompilerAbiLayoutArrayLongTypeName()"
require_text "src/self_hosted/compiler/abi_layout_row_owner.pgy" "CompilerAbiLayoutRowCValueTypeAt(14) == CompilerAbiLayoutOptionFloatCValueType()"
require_text "src/self_hosted/compiler/abi_layout_row_owner.pgy" "CompilerAbiLayoutRowCValueTypeAt(15) == CompilerAbiLayoutOptionDoubleCValueType()"
...
require_text "src/self_hosted/compiler/expected/runtime_call_abi_rows.txt" "schema=pgy.selfhost.runtime-call-abi-row.v1"
require_text "src/self_hosted/compiler/expected/runtime_call_abi_rows.txt" "count=237"
require_text "src/self_hosted/compiler/expected/runtime_call_abi_rows.txt" "24|option-result|option-float.some|pgy_option_some_float|function|generated_runtime_helper"
require_text "src/self_hosted/compiler/expected/runtime_call_abi_rows.txt" "25|option-result|option-double.some|pgy_option_some_double|function|generated_runtime_helper"
require_text "src/self_hosted/compiler/expected/runtime_call_abi_rows.txt" "68|string|substring|pgy_substr|function|generated_runtime_helper"
require_text "src/self_hosted/compiler/expected/runtime_call_abi_rows.txt" "86|host-io|exit|exit|function|target_library"
require_text "src/self_hosted/compiler/expected/runtime_call_abi_rows.txt" "87|native-resource|Slot<Int>.Claim|pgy_claim_Int|function|mir_abi_resource_row"
require_text "src/self_hosted/compiler/expected/runtime_call_abi_rows.txt" "134|native-resource|SecureSlot<String>.Write|pgy_secure_write_String|function|mir_abi_resource_row"
require_text "src/self_hosted/compiler/expected/runtime_call_abi_rows.txt" "207|native-resource|DeviceSlot<Int>.Claim|pgy_claim_device_Int|function|mir_abi_resource_row"
require_text "src/self_hosted/compiler/expected/runtime_call_abi_rows.txt" "236|native-resource|DeviceSlot<String>.SubmitRead|pgy_submit_device_read_String|function|mir_abi_resource_row"
