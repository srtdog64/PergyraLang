...
require_text "src/self_hosted/compiler/test_harness_owner.pgy" "func CompilerHarnessRuntimeCallAbiRowsSuiteName"
require_text "src/self_hosted/compiler/test_harness_owner.pgy" "func CompilerHarnessRuntimeCallAbiRowsPathAt"
...
require_text "src/self_hosted/compiler/expected/compatibility_evolution.txt" "change|source|PrintLine|obsolete|0.8|0.9|1.0|PGYCOMPAT001|Print|docs/compat/PrintLine"
require_text "src/self_hosted/compiler/expected/compatibility_evolution.txt" "change|abi_binary|Array<String>|breaking|0.8|0.9|1.0|PGYCOMPAT002|ArrayOwned<String>|docs/compat/array-string-ownership"
require_text "src/self_hosted/compiler/expected/compatibility_evolution.txt" "change|diagnostic|logical_operand_not_bool|behavior|0.8|0.9|1.0|PGYCOMPAT003|BoolLogicalOperands|docs/compat/logical-bool"
