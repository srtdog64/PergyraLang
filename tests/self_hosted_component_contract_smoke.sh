...
require_text "src/self_hosted/codegen/input/ast_usage_owner.pgy" "func CodegenRuntimeUsageFactsFromSemanticAndArena"
...
require_text "src/self_hosted/codegen/emission/program_emit.pgy" "CodegenRuntimeUsageFactsFromSemanticAndArena("
