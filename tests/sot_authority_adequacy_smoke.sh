...
TRY_SERIALIZED_PARSER="src/self_hosted/parser/ast_text_artifact_parse_owner.pgy"
TRY_GRAPH_IMPORT_OWNER="src/self_hosted/semantic/ast_expression_graph_build_owner.pgy"
...
NOMINAL_EMITTER="src/self_hosted/codegen/emission/nominal_struct_emit_owner.pgy"
ROLE_CONSUMER="src/self_hosted/codegen/input/semantic_role_codegen_view_owner.pgy"
ROLE_EMITTER="src/self_hosted/codegen/emission/role_dispatch_emit_owner.pgy"
...
require_text "$TRY_SERIALIZED_PARSER" "func ParserSerializedExpressionFact("
require_text "$TRY_SERIALIZED_PARSER" "AstExpressionNodeTry(), Concat(\"?\", operand.text), operand"
require_text "$TRY_GRAPH_IMPORT_OWNER" "func SemanticExpressionGraphBuildFromParserFact("
require_text "$TRY_GRAPH_IMPORT_OWNER" "ParserSerializedExpressionFact(expression)"
reject_text "$TRY_GRAPH_IMPORT_OWNER" "SemanticExpressionGraphBuildTryCompactBridge("
reject_text "$TRY_GRAPH_IMPORT_OWNER" "SemanticTryOperand("
